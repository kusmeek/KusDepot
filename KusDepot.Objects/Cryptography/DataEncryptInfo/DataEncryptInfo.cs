...
public sealed class DataEncryptInfo
{
    ...
    [JsonPropertyName("ManagementKeyID")] [JsonRequired]
    ...
    [JsonPropertyName("PublicKey")] [JsonRequired]
    ...
    [JsonPropertyName("Serial")] [JsonRequired]
    ...
    [JsonPropertyName("ThumbPrint")] [JsonRequired]
    public String? ThumbPrint      { get { return this.thumbprint;      } set { this.thumbprint ??= value; } }

    /**<include file='DataEncryptInfo.xml' path='DataEncryptInfo/class[@name="DataEncryptInfo"]/constructor[@name="ParameterlessConstructor"]/*'/>*/
    public DataEncryptInfo() {}
