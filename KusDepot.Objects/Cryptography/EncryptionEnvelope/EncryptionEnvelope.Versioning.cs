...
{
    /**<include file='EncryptionEnvelope.xml' path='EncryptionEnvelope/class[@name="EncryptionEnvelope"]/field[@name="EnvelopeVersion1"]/*'/>*/
    private const Byte EnvelopeVersion1 = 0x01;

    /**<include file='EncryptionEnvelope.xml' path='EncryptionEnvelope/class[@name="EncryptionEnvelope"]/method[@name="GetEnvelopeVersionArray"]/*'/>*/
    private static Byte? GetEnvelopeVersion(Byte[]? input)
    {
        return input is null || input.Length == 0 ? null : input[0];
    }

    /**<include file='EncryptionEnvelope.xml' path='EncryptionEnvelope/class[@name="EncryptionEnvelope"]/method[@name="GetEnvelopeVersionSpan"]/*'/>*/
    private static Byte? GetEnvelopeVersion(ReadOnlySpan<Byte> input)
    {
        return input.IsEmpty ? null : input[0];
    }

    /**<include file='EncryptionEnvelope.xml' path='EncryptionEnvelope/class[@name="EncryptionEnvelope"]/method[@name="GetEnvelopeVersionStream"]/*'/>*/
    ...
    /**<include file='EncryptionEnvelope.xml' path='EncryptionEnvelope/class[@name="EncryptionEnvelope"]/method[@name="GetEnvelopeVersionStreamAsync"]/*'/>*/
    ...
    /**<include file='EncryptionEnvelope.xml' path='EncryptionEnvelope/class[@name="EncryptionEnvelope"]/method[@name="IsSupportedVersion"]/*'/>*/
