...
internal static partial class CryptoCore
{
    ...
    {
        return input is null || certificate is null ? null : EncryptionEnvelope.DecryptArray(input,certificate,aad);
    }
    ...
    {
        return input is null || output is null || certificate is null ? false : EncryptionEnvelope.DecryptStream(input,output,certificate,aad);
    }
    ...
    {
        byteswritten = 0; return certificate is null ? false : EncryptionEnvelope.DecryptSpan(input,output,certificate,out byteswritten,aad);
    }
    ...
    {
        return input is null || certificate is null ? Task.FromResult<Byte[]?>(null) : EncryptionEnvelope.DecryptArrayAsync(input,certificate,aad,cancel);
    }
    ...
    {
        return input is null || output is null || certificate is null ? Task.FromResult(false) : EncryptionEnvelope.DecryptStreamAsync(input,output,certificate,aad,cancel);
    }
    ...
    {
        return input is null || certificate is null ? null : EncryptionEnvelope.EncryptArray(input,certificate,aad,includeaadhash,includeoriginallength,chunksizepower);
    }
    ...
    {
        return input is null || output is null || certificate is null ? false : EncryptionEnvelope.EncryptStream(input,output,certificate,aad,includeaadhash,includeoriginallength,chunksizepower);
    }
    ...
    {
        byteswritten = 0; return certificate is null ? false : EncryptionEnvelope.EncryptSpan(input,output,certificate,out byteswritten,aad,includeaadhash);
    }
    ...
    {
        return input is null || certificate is null ? Task.FromResult<Byte[]?>(null) : EncryptionEnvelope.EncryptArrayAsync(input,certificate,aad,includeaadhash,includeoriginallength,chunksizepower,cancel);
    }
    ...
    {
        return input is null || output is null || certificate is null ? Task.FromResult(false) : EncryptionEnvelope.EncryptStreamAsync(input,output,certificate,aad,includeaadhash,includeoriginallength,chunksizepower,cancel);
    }

    /**<include file='CryptoCore.xml' path='CryptoCore/class[@name="CryptoCore"]/method[@name="EncryptUtf16"]/*'/>*/
    internal static Boolean EncryptUtf16(String? input , Stream? output , X509Certificate2? certificate , Byte[]? aad = null , Boolean includeaadhash = true , Boolean includeoriginallength = true , Int32 chunksizepower = DefaultCryptoChunkPower)
    {
        return String.IsNullOrEmpty(input) || output is null || certificate is null ? false : EncryptionEnvelope.EncryptUtf16(input,output,certificate,aad,includeaadhash,includeoriginallength,chunksizepower);
    }

    /**<include file='CryptoCore.xml' path='CryptoCore/class[@name="CryptoCore"]/method[@name="EncryptUtf16Async"]/*'/>*/
    internal static Task<Boolean> EncryptUtf16Async(String? input , Stream? output , X509Certificate2? certificate , Byte[]? aad = null , Boolean includeaadhash = true , Boolean includeoriginallength = true , Int32 chunksizepower = DefaultCryptoChunkPower , CancellationToken cancel = default)
    {
        return String.IsNullOrEmpty(input) || output is null || certificate is null ? Task.FromResult(false) : EncryptionEnvelope.EncryptUtf16Async(input,output,certificate,aad,includeaadhash,includeoriginallength,chunksizepower,cancel);
    }
}