...
public interface IMetaBase : ICommon
{
    ...
    /**<include file='IMetaBase.xml' path='IMetaBase/interface[@name="IMetaBase"]/method[@name="GetMetaBaseIntegrityHash"]/*'/>*/
    Byte[] GetMetaBaseIntegrityHash();
    ...
    /**<include file='IMetaBase.xml' path='IMetaBase/interface[@name="IMetaBase"]/method[@name="GetObjectFILE"]/*'/>*/
    ...
    /**<include file='IMetaBase.xml' path='IMetaBase/interface[@name="IMetaBase"]/method[@name="SetNotes"]/*'/>*/
    Boolean SetNotes(IEnumerable<String>? notes);

    /**<include file='IMetaBase.xml' path='IMetaBase/interface[@name="IMetaBase"]/method[@name="SetObjectFILE"]/*'/>*/
    Boolean SetObjectFILE(String? objectfile);
    ...
    /**<include file='IMetaBase.xml' path='IMetaBase/interface[@name="IMetaBase"]/method[@name="SetTags"]/*'/>*/
    Boolean SetTags(IEnumerable<String>? tags);
