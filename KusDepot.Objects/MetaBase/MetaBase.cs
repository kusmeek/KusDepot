...
public abstract class MetaBase : Common , IMetaBase
{
    ...
    /**<include file='MetaBase.xml' path='MetaBase/class[@name="MetaBase"]/property[@name="MyFILE"]/*'/>*/
    [JsonPropertyName("FILE")] [JsonRequired] [IgnoreDataMember]
    public String? MyFILE
    {
        get { try { return this.GetFILE(); } catch { return null; } }

        set { try { this.SetFILE(value); } catch {} }
    }
    ...
    /**<include file='MetaBase.xml' path='MetaBase/class[@name="MetaBase"]/property[@name="MyName"]/*'/>*/
    [JsonPropertyName("Name")] [JsonRequired] [IgnoreDataMember]
    public String? MyName
    {
        get { try { return this.GetName(); } catch { return null; } }

        set { try { this.SetName(value); } catch {} }
    }
    ...
    /**<include file='MetaBase.xml' path='MetaBase/class[@name="MetaBase"]/property[@name="MyNotes"]/*'/>*/
    [JsonPropertyName("Notes")] [JsonRequired] [IgnoreDataMember]
    public String[]? MyNotes
    {
        get { try { return this.GetNotes()?.ToArray(); } catch { return null; } }

        set { try { this.SetNotes(value); } catch {} }
    }
    ...
    /**<include file='MetaBase.xml' path='MetaBase/class[@name="MetaBase"]/property[@name="MyTags"]/*'/>*/
    [IgnoreDataMember] [JsonPropertyName("Tags")] [JsonRequired]
    public String[]? MyTags
    {
        get { try { return this.GetTags()?.ToArray(); } catch { return null; } }

        set { try { this.SetTags(value); } catch {} }
    }
    ...
    public virtual Boolean SetNotes(IEnumerable<String>? notes)
    {
        try
        {
            ...
            HashSet<String> _ = new(notes.Select(_=>new String(_)));

            if(!this.Sync.Meta.Wait(SyncTime)) { throw SyncException; }

            try
            {
                if(Equals(_.Count,0)) { this.Notes = null; MN(); return true; }
    ...
    public virtual Boolean SetTags(IEnumerable<String>? tags)
    {
        try
        {
            ...
            HashSet<String> _ = new(tags.Select(_=>new String(_)));

            if(!this.Sync.Meta.Wait(SyncTime)) { throw SyncException; }

            try
            {
                if(Equals(_.Count,0)) { this.Tags = null; MN(); return true; }
