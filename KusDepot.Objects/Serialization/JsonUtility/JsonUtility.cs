...
public static class JsonUtility
{
    ...
    private static JsonSerializerOptions Options = new()
    {
        ...
        TypeInfoResolver = JsonTypeInfoResolver.Combine(
            JsonContext.Default,new DefaultJsonTypeInfoResolver())
    };

    /**<include file='JsonUtility.xml' path='JsonUtility/class[@name="JsonUtility"]/method[@name="IsSupportedType"]/*'/>*/
    public static Boolean IsSupported(Type? type)
    {
        try { return type is not null && JsonContext.Default.GetTypeInfo(type) is not null; }

        catch ( Exception _ ) { KusDepotLog.Error(_,IsSupportedFail,type?.FullName); if(NoExceptions) { return false; } throw; }
    }

    /**<include file='JsonUtility.xml' path='JsonUtility/class[@name="JsonUtility"]/method[@name="IsSupportedGeneric"]/*'/>*/
    public static Boolean IsSupported<T>()
    {
        try { return IsSupported(typeof(T)); }

        catch ( Exception _ ) { KusDepotLog.Error(_,IsSupportedFail,typeof(T).FullName); if(NoExceptions) { return false; } throw; }
    }
    ...
    public static Byte[] Serialize(Object? value , Type inputtype)
    {
        ...
        catch ( Exception _ ) { KusDepotLog.Error(_,SerializeFail,inputtype?.FullName); if(NoExceptions) { return Array.Empty<Byte>(); } throw; }
    }
    ...
    public static T? Deserialize<T>(Byte[]? input)
    {
        ...
        catch ( Exception _ ) { KusDepotLog.Error(_,DeserializeFail,typeof(T).FullName); if(NoExceptions) { return default; } throw; }
    }

    /**<include file='JsonUtility.xml' path='JsonUtility/class[@name="JsonUtility"]/method[@name="DeserializeMemory"]/*'/>*/
    public static T? Deserialize<T>(ReadOnlyMemory<Byte>? input)
    {
        if(input is null || !input.HasValue) { return default; }

        try { return JsonSerializer.Deserialize<T>(input.Value.Span,Options); }
    ...
    public static Object? Deserialize(Byte[]? input , Type outputtype)
    {
        ...
        catch ( Exception _ ) { KusDepotLog.Error(_,DeserializeFail,outputtype?.FullName); if(NoExceptions) { return null; } throw; }
    }

    /**<include file='JsonUtility.xml' path='JsonUtility/class[@name="JsonUtility"]/method[@name="DeserializeMemoryType"]/*'/>*/
    public static Object? Deserialize(ReadOnlyMemory<Byte>? input , Type outputtype)
    {
        if(input is null || !input.HasValue) { return null; }

        try { return JsonSerializer.Deserialize(input.Value.Span,outputtype,Options); }
    ...
    public static T? Parse<T>(String? input)
    {
        ...
        catch ( Exception _ ) { KusDepotLog.Error(_,ParseFail,typeof(T).FullName); if(NoExceptions) { return default; } throw; }
    }
    ...
    public static String ToJsonString<T>(T? value)
    {
        ...
        catch ( Exception _ ) { KusDepotLog.Error(_,ToStringFail,typeof(T).FullName); if(NoExceptions) { return String.Empty; } throw; }
    }
    ...
    public static String ToJsonString(Object? value , Type inputtype)
    {
        ...
        catch ( Exception _ ) { KusDepotLog.Error(_,ToStringFail,inputtype?.FullName); if(NoExceptions) { return String.Empty; } throw; }
    }
    ...
    public static Boolean TryParse<T>(String? input , [MaybeNullWhen(false)] out T value)
    {
        ...
        catch ( Exception _ ) { value = default; KusDepotLog.Error(_,TryParseFail,typeof(T).FullName); if(NoExceptions) { return false; } throw; }
    }
    ...
    public static Boolean TryParse(String? input , Type outputtype , out Object? value)
    {
        ...
        catch ( Exception _ ) { value = null; KusDepotLog.Error(_,TryParseFail,outputtype?.FullName); if(NoExceptions) { return false; } throw; }
    }
    ...
    public static Boolean ToFile(String path , Object? value , Type inputtype)
    {
        ...
        catch ( Exception _ ) { KusDepotLog.Error(_,ToFileFail,inputtype?.FullName); if(NoExceptions) { return false; } throw; }
    }
    ...
    public static T? FromFile<T>(String path)
    {
        ...
        catch ( Exception _ ) { KusDepotLog.Error(_,FromFileFail,typeof(T).FullName); if(NoExceptions) { return default; } throw; }
    }
    ...
    public static Object? FromFile(String path , Type outputtype)
    {
        ...
        catch ( Exception _ ) { KusDepotLog.Error(_,FromFileFail,outputtype?.FullName); if(NoExceptions) { return null; } throw; }
    }
    ...
    public static String WriteIndented(Object? value , Type inputtype)
    {
        ...
        catch ( Exception _ ) { KusDepotLog.Error(_,WriteIndentedFail,inputtype?.FullName); if(NoExceptions) { return String.Empty; } throw; }
    }
}