...
internal static class Serialization
{
    ...
    internal static IEnumerable<Type> GetAllKnownTypes()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetAllKnownTypesFail); throw; }
    }
    ...
    internal static IEnumerable<Type> GetDataItemKnownTypes()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetDataItemKnownTypesFail); throw; }
    }
    ...
    internal static IEnumerable<Type> GetSecurityKnownTypes()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetSecurityKnownTypesFail); throw; }
    }
}