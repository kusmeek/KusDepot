...
public sealed class Activity : IDisposable
{
    ...
    public Serilog.ILogger?         Logger   { get { return this.logger;   } set { this.logger   ??= value; } }
    ...
    public static Activity? CreateActivity(CommandDetails? details)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,CreateActivityFail); return null; }
    }
    ...
    public Boolean LogWorkflowEvent(String? action , String? data)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,LogWorkflowEventFail); return false; }
    }
    ...
    public Boolean StartWorkflowAction(String? action = null , String? data = null)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,StartWorkflowActionFail); return false; }
    }
    ...
    public Boolean StopWorkflowAction(String? action = null , String? data = null)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,StopWorkflowActionFail); return false; }
    }
