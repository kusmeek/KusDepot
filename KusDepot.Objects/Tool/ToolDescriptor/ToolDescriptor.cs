...
public sealed record class ToolDescriptor : IEquatable<ToolDescriptor> , IParsable<ToolDescriptor>
{
    ...
    /**<include file='ToolDescriptor.xml' path='ToolDescriptor/record[@name="ToolDescriptor"]/property[@name="Manifest"]/*'/>*/
    [JsonPropertyName("Manifest")] [JsonRequired]
    [DataMember(Name = "Manifest" , EmitDefaultValue = true , IsRequired = true)] [Id(2)]
    ...
    [DataMember(Name = "Specifications" , EmitDefaultValue = true , IsRequired = true)] [Id(3)]
    ...
    [DataMember(Name = "ExtendedData" , EmitDefaultValue = true , IsRequired = true)] [Id(4)]
    ...
    public static ToolDescriptor Create(ITool tool , ToolManifest? manifest = null) => new()
    {
        ID = tool?.GetID(),
        Type = tool?.GetType().FullName,
        Manifest = manifest is null ? null : JsonUtility.ToJsonString(manifest)
    };
