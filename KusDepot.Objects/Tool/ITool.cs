...
public interface ITool : ICommon , IComparable<ITool> , IEquatable<ITool> , IDisposable , IAsyncDisposable , IHostedLifecycleService
{
    ...
    /**<include file='ITool.xml' path='ITool/interface[@name="ITool"]/method[@name="CreateExecutiveKeyAsync"]/*'/>*/
    Task<ExecutiveKey?> CreateExecutiveKeyAsync(ManagementKey? managementkey , CancellationToken? cancel = null);
    ...
    /**<include file='ITool.xml' path='ITool/interface[@name="ITool"]/method[@name="GetToolManifest"]/*'/>*/
    ToolManifest? GetToolManifest(AccessKey? key = null);
    ...
    /**<include file='ITool.xml' path='ITool/interface[@name="ITool"]/method[@name="Lock"]/*'/>*/
    Boolean Lock(AccessKey? key = null);
    ...
    /**<include file='ITool.xml' path='ITool/interface[@name="ITool"]/method[@name="RequestAccessAsync"]/*'/>*/
    Task<AccessKey?> RequestAccessAsync(AccessRequest? request = null , CancellationToken? cancel = null);

    /**<include file='ITool.xml' path='ITool/interface[@name="ITool"]/method[@name="RevokeAccess"]/*'/>*/
    Boolean RevokeAccess(AccessKey? key);

    /**<include file='ITool.xml' path='ITool/interface[@name="ITool"]/method[@name="RevokeAccessAsync"]/*'/>*/
    Task<Boolean> RevokeAccessAsync(AccessKey? key = null , CancellationToken? cancel = null);
    ...
    /**<include file='ITool.xml' path='ITool/interface[@name="ITool"]/method[@name="UnLock"]/*'/>*/
    Boolean UnLock(AccessKey? key = null);
