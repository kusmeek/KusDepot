...
public partial class Tool : Common , IHostedLifecycleService , ITool
{
    ...
    public Tool(IAccessManager? accessmanager = null , IEnumerable<DataItem>? data = null , Guid? id = null , ToolServiceProvider? services = null,
           Dictionary<String,ICommand>? commands = null , IConfiguration? configuration = null , ILogger? logger = null)
    {
        try
        {
    ...
    protected virtual Boolean ResolveLogger(Serilog.ILogger? logger = null)
    {
        ...
        try
        {
            ...
            this.Logger = logger ?? this.ToolServices?.GetService<Serilog.ILogger>();
