...
public sealed class AccessManagerState
{
    ...
    public void Clear()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,ClearFail); if(NoExceptions) { return; } throw; }
    }
    ...
    public Byte[] Serialize()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,SerializeFail); if(NoExceptions) { return Array.Empty<Byte>(); } throw; }
    }
}