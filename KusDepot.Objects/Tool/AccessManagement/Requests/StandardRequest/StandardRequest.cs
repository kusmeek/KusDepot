...
[Alias("KusDepot.Security.Requests.StandardRequest")] [GenerateSerializer] [Immutable]
...
public sealed record class StandardRequest : AccessRequest , IParsable<StandardRequest>
{
    ...
    {
        RequestedKeyType = nameof(ClientKey); Operations = ProtectedOperationSets.Client;
    }

    /**<include file='StandardRequest.xml' path='StandardRequest/class[@name="StandardRequest"]/constructor[@name="Constructor"]/*'/>*/
    public StandardRequest(String subject)
    {
        Subject = subject; RequestedKeyType = nameof(ClientKey); Operations = ProtectedOperationSets.Client;
    }
