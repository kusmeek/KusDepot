...
public sealed class LifeCycleStateMachine
{
    ...
    public Boolean ToActive()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,ToActiveFail,ToolID); throw; }
    ...
    public Boolean ToInActive()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,ToInActiveFail,ToolID); throw; }
    ...
    public Boolean ToInitialized()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,ToInitializedFail,ToolID); throw; }
    ...
    public Boolean ToError()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,ToErrorFail,ToolID); throw; }
    ...
    public Boolean ToStarting()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,ToStartingFail,ToolID); throw; }
    ...
    public Boolean ToStopping()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,ToStoppingFail,ToolID); throw; }
    ...
    public Boolean ToUnInitialized()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,ToUnInitializedFail,ToolID); throw; }
