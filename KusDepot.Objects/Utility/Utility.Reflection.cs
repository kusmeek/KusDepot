...
public static partial class Utility
{
    ...
    public static Dictionary<String,String> GetAllDataTypes()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetAllDataTypesFail); if(NoExceptions) { return new(); } throw; }
    }
    ...
    public static List<String> GetAllTags(Type type)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetAllTagsFail); if(NoExceptions) { return new(); } throw; }
    }
    ...
    public static Dictionary<String,String>? GetCommandSpecifications(Type? type)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetCommandSpecificationsFail); if(NoExceptions) { return null; } throw; }
    }
    ...
    public static HashSet<Tuple<String,String,String>>? GetAssemblyCommands(Byte[]? assembly = null , IEnumerable<String>? dllpaths = null)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetAssemblyCommandsFail); if(NoExceptions) { return null; } throw; }
    }
    ...
    public static HashSet<Tuple<String,String>>? GetAssemblyServices(Byte[]? assembly = null , IEnumerable<String>? dllpaths = null)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetAssemblyServicesFail); if(NoExceptions) { return null; } throw; }
    }
    ...
    private static List<String> GetNetDlls()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetNetDllsFail); if(NoExceptions) { return []; } throw; }
    }
}