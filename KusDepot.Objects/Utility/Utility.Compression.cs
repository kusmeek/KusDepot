...
public static partial class Utility
{
    ...
    public static Byte[]? Compress(this Byte[]? input)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,CompressFail); if(NoExceptions) { return null; } throw; }
    }
    ...
    public static Boolean Compress(Stream? input , Stream? output , CancellationToken cancel = default)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,CompressFail); if(NoExceptions) { return false; } throw; }
    }
    ...
    public static Byte[]? Decompress(this Byte[]? input)
    {
        ...
        catch ( InvalidDataException _ ) { Log.Verbose(_,DecompressFail); return null; }

        catch ( Exception _ ) { Log.Error(_,DecompressFail); if(NoExceptions) { return null; } throw; }
    }
    ...
    public static Boolean Decompress(Stream? input , Stream? output , CancellationToken cancel = default)
    {
        ...
        catch ( InvalidDataException _ ) { Log.Verbose(_,DecompressFail); return false; }

        catch ( Exception _ ) { Log.Error(_,DecompressFail); if(NoExceptions) { return false; } throw; }
    }
