...
public static partial class Utility
{
    ...
    public static X509Certificate2? DeserializeCertificate(Byte[]? certificate)
    {
        try
        {
            if(certificate is null || certificate.Length == 0) { return null; }
    ...
    /**<include file='Utility.xml' path='Utility/class[@name="Utility"]/method[@name="EncryptUtf16"]/*'/>*/
    public static Byte[]? EncryptUtf16(this String? input , X509Certificate2? certificate , Byte[]? aad = null , Boolean includeaadhash = true , Boolean includeoriginallength = true , Int32 chunksizepower = DefaultCryptoChunkPower)
    {
        try
        {
            if(String.IsNullOrEmpty(input) || certificate is null) { return null; }

            using var output = new MemoryStream();

            return CryptoCore.EncryptUtf16(input,output,certificate,aad,includeaadhash,includeoriginallength,chunksizepower) ? output.ToArray() : null;
        }
        catch ( Exception _ ) { KusDepotLog.Error(_,EncryptUtf16Fail); if(NoExceptions) { return null; } throw; }
    }

    /**<include file='Utility.xml' path='Utility/class[@name="Utility"]/method[@name="EncryptUtf16Stream"]/*'/>*/
    public static Boolean EncryptUtf16(String? input , Stream? output , X509Certificate2? certificate , Byte[]? aad = null , Boolean includeaadhash = true , Boolean includeoriginallength = true , Int32 chunksizepower = DefaultCryptoChunkPower)
    {
        try { return CryptoCore.EncryptUtf16(input,output,certificate,aad,includeaadhash,includeoriginallength,chunksizepower); }

        catch ( Exception _ ) { KusDepotLog.Error(_,EncryptUtf16Fail); if(NoExceptions) { return false; } throw; }
    }

    /**<include file='Utility.xml' path='Utility/class[@name="Utility"]/method[@name="EncryptUtf16Async"]/*'/>*/
    public static async Task<Byte[]?> EncryptUtf16Async(this String? input , X509Certificate2? certificate , Byte[]? aad = null , Boolean includeaadhash = true , Boolean includeoriginallength = true , Int32 chunksizepower = DefaultCryptoChunkPower , CancellationToken cancel = default)
    {
        try
        {
            if(String.IsNullOrEmpty(input) || certificate is null || cancel.IsCancellationRequested) { return null; }

            using var output = new MemoryStream();

            return await CryptoCore.EncryptUtf16Async(input,output,certificate,aad,includeaadhash,includeoriginallength,chunksizepower,cancel).ConfigureAwait(false) ? output.ToArray() : null;
        }
        catch ( OperationCanceledException ) { return null; }

        catch ( Exception _ ) { KusDepotLog.Error(_,EncryptUtf16AsyncFail); if(NoExceptions) { return null; } throw; }
    }

    /**<include file='Utility.xml' path='Utility/class[@name="Utility"]/method[@name="EncryptUtf16StreamAsync"]/*'/>*/
    public static Task<Boolean> EncryptUtf16Async(String? input , Stream? output , X509Certificate2? certificate , Byte[]? aad = null , Boolean includeaadhash = true , Boolean includeoriginallength = true , Int32 chunksizepower = DefaultCryptoChunkPower , CancellationToken cancel = default)
    {
        try { return CryptoCore.EncryptUtf16Async(input,output,certificate,aad,includeaadhash,includeoriginallength,chunksizepower,cancel); }

        catch ( OperationCanceledException ) { return Task.FromResult(false); }

        catch ( Exception _ ) { KusDepotLog.Error(_,EncryptUtf16AsyncFail); if(NoExceptions) { return Task.FromResult(false); } throw; }
    }
