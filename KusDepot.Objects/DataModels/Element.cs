...
public sealed record class Element
{
    ...
    /**<include file='Element.xml' path='Element/record[@name="Element"]/property[@name="ObjectFILE"]/*'/>*/
    [JsonPropertyName("ObjectFILE")] [JsonInclude]
    [DataMember(Name = "ObjectFILE" , EmitDefaultValue = true , IsRequired = true)] [Id(11)]
    ...
    [DataMember(Name = "ObjectType" , EmitDefaultValue = true , IsRequired = true)] [Id(12)]
...
public sealed record ElementQuery
{
    ...
    /**<include file='Element.xml' path='Element/record[@name="ElementQuery"]/property[@name="ObjectFILE"]/*'/>*/
    [JsonPropertyName("ObjectFILE")] [JsonInclude]
    [DataMember(Name = "ObjectFILE" , EmitDefaultValue = true , IsRequired = true)] [Id(11)]
    public String? ObjectFILE         {get;init;}
...
public sealed record ElementResponse
{
    ...
    [JsonPropertyName("Elements")] [JsonInclude]
