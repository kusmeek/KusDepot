...
public sealed record class Service
{
    ...
    /**<include file='Service.xml' path='Service/record[@name="Service"]/property[@name="ObjectFILE"]/*'/>*/
    [JsonPropertyName("ObjectFILE")] [JsonInclude]
    [DataMember(Name = "ObjectFILE" , EmitDefaultValue = true , IsRequired = true)] [Id(10)]
    ...
    [JsonPropertyName("ServiceInterfaces")] [JsonInclude]
    [DataMember(Name = "ServiceInterfaces" , EmitDefaultValue = true , IsRequired = true)] [Id(12)]
    ...
    [JsonPropertyName("ServiceSpecifications")] [JsonInclude]
    [DataMember(Name = "ServiceSpecifications" , EmitDefaultValue = true , IsRequired = true)] [Id(13)]
    ...
    [JsonPropertyName("ServiceType")] [JsonInclude]
    [DataMember(Name = "ServiceType" , EmitDefaultValue = true , IsRequired = true)] [Id(14)]
...
public sealed record ServiceQuery
{
    ...
    /**<include file='Service.xml' path='Service/record[@name="ServiceQuery"]/property[@name="ObjectFILE"]/*'/>*/
    [JsonPropertyName("ObjectFILE")] [JsonInclude]
    [DataMember(Name = "ObjectFILE" , EmitDefaultValue = true , IsRequired = true)] [Id(10)]
    public String? ObjectFILE            {get;init;}
