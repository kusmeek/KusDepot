...
public abstract class DataItem : MetaBase , ICloneable , IComparable<DataItem> , IDataItem , IEquatable<DataItem>
{
    ...
    protected async Task<Boolean> CheckDataHashCore(Byte[]? data , Stream? stream , CancellationToken cancel = default)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,CheckDataHashCoreFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public virtual Boolean ClearEncryptedData(ManagementKey? managementkey = null)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,ClearEncryptedDataFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public TResult? Clone<TResult>() where TResult : DataItem
    {
        ...
        catch ( Exception _ ) { Log.Error(_,CloneFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return null; } throw; }
    }
    ...
    public override ManagementKey? CreateManagementKey(String? subject)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,CreateManagementKeyFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return null; } throw; }
    }
    ...
    protected Byte[]? DecryptDataBuffer(Byte[]? data , ManagementKey? managementkey)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,DecryptDataBufferFail,MyTypeName,MyID); return null; }
    }
    ...
    protected async Task<Stream?> DecryptDataCore(Byte[]? data = null , String? file = null , ManagementKey? managementkey = null , CancellationToken cancel = default)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,DecryptDataCoreFail,MyTypeName,MyID); return null; }
    }
    ...
    protected Byte[]? EncryptDataBuffer(Byte[]? data , ManagementKey? managementkey)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,EncryptDataBufferFail,MyTypeName,MyID); return null; }
    }
    ...
    protected async Task<Stream?> EncryptDataCore(Byte[]? data = null , String? file = null , ManagementKey? managementkey = null , CancellationToken cancel = default)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,EncryptDataCoreFail,MyTypeName,MyID); return null; }
    }
    ...
    public static TResult? FromFile<TResult>(String path)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,FromFileFail); if(NoExceptions) { return default; } throw; }
    }
    ...
    public virtual Stream? GetContentStream()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetContentStreamFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return null; } throw; }
    }
    ...
    public virtual Boolean GetContentStreamed()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetContentStreamedFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public virtual Boolean GetDataEncrypted()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetDataEncryptedFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public virtual DataEncryptInfo? GetDataEncryptInfo()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetDataEncryptInfoFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return null; } throw; }
    }
    ...
    public virtual Boolean GetDataMasked()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetDataMaskedFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    protected virtual Byte[]? GetEncryptedData()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetEncryptedDataFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return null; } throw; }
    }
    ...
    protected virtual Dictionary<String,Byte[]>? GetSecureHashes()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetSecureHashesFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return null; } throw; }
    }
    ...
    protected virtual Dictionary<String,Byte[]>? GetSecureSignatures()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetSecureSignaturesFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return null; } throw; }
    }
    ...
    protected override SyncNode GetSyncNode()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetSyncNodeFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return null!; } throw; }
    }
    ...
    public new virtual String? GetType()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetTypeFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return null; } throw; }
    }
    ...
    public override Boolean Initialize()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,InitializeFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public virtual Boolean MaskData(Boolean mask = true , ManagementKey? managementkey = null)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,mask?MaskDataFail:UnMaskDataFail,MyTypeName,MyID); return false; }
    }
    ...
    public static DataItem? Deserialize(Byte[] input , IFormatProvider? format = null)
    {
        ...
        catch ( Exception _ ) { if(NoExceptions) { return null; } Log.Error(_,DeserializeFail); throw; }
    }
    ...
    public static TResult? Parse<TResult>(String input , IFormatProvider? format = null) where TResult : DataItem
    {
        ...
        catch ( Exception _ ) { Log.Error(_,ParseFail); if(NoExceptions) { return null; } throw; }
    }
    ...
    public static TResult? Deserialize<TResult>(Byte[] input , IFormatProvider? format = null) where TResult : DataItem
    {
        ...
        catch ( Exception _ ) { Log.Error(_,DeserializeFail); if(NoExceptions) { return null; } throw; }
    }
    ...
    protected override void RefreshSyncNodes()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,RefreshSyncNodeFail,MyTypeName,MyID); throw; }
    }
    ...
    public override Boolean RegisterManager(ManagementKey? managementkey)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,RegisterManagerFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public override ManagementKey? RegisterManager(X509Certificate2? certificate)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,RegisterManagerFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return null; } throw; }
    }
    ...
    public override Boolean SetID(Guid? id)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,SetIDFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public virtual Boolean SetType(String? type)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,SetTypeFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public virtual String? SignData(String? field , ManagementKey? managementkey)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,SignDataFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return null; } throw; }
    ...
    public virtual Boolean ToFile(String path)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,ToFileFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    ...
    private String ToStringCore()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,ToStringFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return String.Empty; } throw; }
    ...
    protected Byte[] Serialize()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,SerializeFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return Array.Empty<Byte>(); } throw; }
    }
    ...
    public override Boolean UnLock(ManagementKey? managementkey)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,UnLockFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public override Boolean UnRegisterManager(ManagementKey? managementkey)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,UnRegisterManagerFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    protected virtual Boolean UpdateSecureHash(String? key , Byte[]? data , Boolean store = false)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,UpdateSecureHashFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    protected virtual Boolean UpdateSecureSignature(String? key , ManagementKey? managementkey)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,UpdateSecureSignatureFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw;  }
    }
    ...
    protected virtual async Task<Boolean> VerifyDataCore(String? field , ManagementKey? managementkey , Byte[]? currentfielddata , Stream? currentfieldstream = null , CancellationToken cancel = default)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,VerifyDataCoreFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    ...
    protected virtual async Task<Boolean> VerifySecureHash(String? key , Byte[]? data , CancellationToken cancel = default)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,VerifySecureHashFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    protected virtual Boolean VerifySecureSignature(String key , ManagementKey? managementKey)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,VerifySecureSignatureFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
