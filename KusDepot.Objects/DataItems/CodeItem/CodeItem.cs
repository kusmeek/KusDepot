...
public sealed partial class CodeItem : DataItem , IComparable<CodeItem> , IEquatable<CodeItem> , IExtensibleDataObject , IParsable<CodeItem>
{
    ...
    public static CodeItem? FromFile(String path)
    {
        try
        {
            ...
            return OrleansUtility.FromFile<CodeItem>(path);
        }
        ...
        try
        {
            ...
            try
            {
                ...
                if(this.DataEncrypted)
                {
                    ...
                    return new() { Code = new(GetUtf16String(m)) };
                }

                return this.Content is not null ? new() { Code = DataIsolation.IsEnabled() ? new(this.Content) : this.Content } : null;
            }
            finally { this.Sync.Data.Release(); }
        }
    ...
    public static new CodeItem? Parse(String input , IFormatProvider? format = null)
    {
        try
        {
            return OrleansUtility.ParseBase64<CodeItem>(input);
        }
