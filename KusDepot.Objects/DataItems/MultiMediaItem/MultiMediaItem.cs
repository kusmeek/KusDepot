...
public sealed class MultiMediaItem : DataItem , IComparable<MultiMediaItem> , IEquatable<MultiMediaItem> , IExtensibleDataObject , IParsable<MultiMediaItem>
{
    ...
    /**<include file='MultiMediaItem.xml' path='MultiMediaItem/class[@name="MultiMediaItem"]/property[@name="MyArtists"]/*'/>*/
    [JsonPropertyName("Artists")] [JsonRequired] [IgnoreDataMember]
    public String[]? MyArtists
    {
        get { try { return this.GetArtists()?.ToArray(); } catch { return null; } }

        set { try { this.SetArtists(value); } catch {} }
    }
    ...
    /**<include file='MultiMediaItem.xml' path='MultiMediaItem/class[@name="MultiMediaItem"]/content[@name="MyContent"]/*'/>*/
    [JsonPropertyName("Content")] [Description(MultiMediaContentDescription)] [JsonRequired] [IgnoreDataMember]
    ...
    /**<include file='MultiMediaItem.xml' path='MultiMediaItem/class[@name="MultiMediaItem"]/property[@name="MyTitle"]/*'/>*/
    [JsonPropertyName("Title")] [JsonRequired] [IgnoreDataMember]
    public String? MyTitle
    {
        get { try { return this.GetTitle(); } catch { return null; } }

        set { try { this.SetTitle(value); } catch {} }
    }
    ...
    public static MultiMediaItem? FromFile(String path)
    {
        try
        {
            ...
            return DataContractUtility.FromFile<MultiMediaItem>(path,SerializationData.ForType(typeof(MultiMediaItem)));
        }
    ...
    public Byte[]? GetContent()
    {
        try
        {
            ...
            try
            {
                return this.Content is null ? null : this.Content.Clone() as Byte[];
            }
            finally { this.Sync.Data.Release(); }
        }
    ...
    public static new MultiMediaItem? Parse(String input , IFormatProvider? format = null)
    {
        try
        {
            return DataContractUtility.ParseBase64<MultiMediaItem>(input,SerializationData.ForType(typeof(MultiMediaItem)));
        }
    ...
    public static Boolean TryParse([NotNullWhen(true)] String? input , IFormatProvider? format , [MaybeNullWhen(false)] out MultiMediaItem item)
    {
        ...
        try
        {
            return DataContractUtility.TryParseBase64(input,SerializationData.ForType(typeof(MultiMediaItem)),out item);
        }
