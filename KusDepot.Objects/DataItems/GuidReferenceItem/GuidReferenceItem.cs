...
public sealed class GuidReferenceItem : DataItem , IComparable<GuidReferenceItem> , IEquatable<GuidReferenceItem> , IExtensibleDataObject , IParsable<GuidReferenceItem>
{
    ...
    /**<include file='GuidReferenceItem.xml' path='GuidReferenceItem/class[@name="GuidReferenceItem"]/property[@name="MyContent"]/*'/>*/
    [JsonPropertyName("Content")] [JsonRequired] [IgnoreDataMember]
    public Guid? MyContent
    {
    ...
    /**<include file='GuidReferenceItem.xml' path='GuidReferenceItem/class[@name="GuidReferenceItem"]/property[@name="MyNext"]/*'/>*/
    [JsonPropertyName("Next")] [JsonRequired] [IgnoreDataMember]
    public Guid? MyNext
    {
        get
        {
            try { return this.GetNext()?.GetContent(); } catch { return null; }
        }

        set
        {
            try { this.SetNext(value is null ? null : new GuidReferenceItem(value)); } catch {}
        }
    }
    ...
    /**<include file='GuidReferenceItem.xml' path='GuidReferenceItem/class[@name="GuidReferenceItem"]/property[@name="MyPrevious"]/*'/>*/
    [JsonPropertyName("Previous")] [JsonRequired] [IgnoreDataMember]
    public Guid? MyPrevious
    {
        get
        {
            try { return this.GetPrevious()?.GetContent(); } catch { return null; }
        }

        set
        {
            try { this.SetPrevious(value is null ? null : new GuidReferenceItem(value)); } catch {}
        }
    }
    ...
    /**<include file='GuidReferenceItem.xml' path='GuidReferenceItem/class[@name="GuidReferenceItem"]/property[@name="MyUndirectedLinks"]/*'/>*/
    [JsonPropertyName("UndirectedLinks")] [JsonRequired] [IgnoreDataMember]
    public Guid[]? MyUndirectedLinks
    {
        get
        {
            try
            {
                return this.GetUndirectedLinks()?
                    .Select(_ => _.GetContent())
                    .Where(_ => _.HasValue)
                    .Select(_ => _!.Value)
                    .ToArray();
            }
        ...
        set
        {
            try { this.SetUndirectedLinks(value?.Select(_ => new GuidReferenceItem(_)).ToArray()); }
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        if(!await UpdateSecureHashAsync(DataSecurityCNKey,
                            this.Content.HasValue ? this.Content.Value.ToByteArray() : null,false,cancel)) { return false; }
    ...
    public Boolean Equals(GuidReferenceItem? other)
    {
        try
        {
            ...
            try
            {
                var _ = other.GetContent(); if(this.Content is null && _ is null) { return true; } return Guid.Equals(this.Content,_);
            }
            finally { this.Sync.Data.Release(); }
        }
    ...
    public static GuidReferenceItem? FromFile(String path)
    {
        try
        {
            ...
            return DataContractUtility.FromFile<GuidReferenceItem>(path,SerializationData.ForType(typeof(GuidReferenceItem)));
        }
    ...
    public override async Task<DataContent?> GetDataContent(ManagementKey? managementkey = null , CancellationToken cancel = default)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                if(this.DataEncrypted && Array.Empty<Byte>().AsSpan().SequenceEqual(this.EncryptedData.AsSpan()) is false)
                {
    ...
    protected override Int32 GetHashCode_NoSync()
    {
        try
        {
            return BitConverter.ToInt32(SHA512.HashData(this.Content?.ToByteArray() ?? Array.Empty<Byte>()),0);
        }
        catch ( Exception _ ) { KusDepotLog.Error(_,GetHashCodeFail,MyTypeName,MyID); throw; }
    }
    ...
    protected override async Task<Int32> GetHashCode_NoSyncAsync(CancellationToken cancel = default)
    {
        try
        {
            using var m = new MemoryStream(this.Content?.ToByteArray() ?? Array.Empty<Byte>(),false);
    ...
    public GuidReferenceItem? GetNext()
    {
        try
        {
            ...
            try { return this.Next?.Clone() as GuidReferenceItem; }
    ...
    public GuidReferenceItem? GetPrevious()
    {
        try
        {
            ...
            try { return this.Previous?.Clone() as GuidReferenceItem; }
    ...
    public static new GuidReferenceItem? Parse(String input , IFormatProvider? format = null)
    {
        try
        {
            return DataContractUtility.ParseBase64<GuidReferenceItem>(input,SerializationData.ForType(typeof(GuidReferenceItem)));
        }
    ...
    public static Boolean TryParse([NotNullWhen(true)] String? input , IFormatProvider? format , [MaybeNullWhen(false)] out GuidReferenceItem item)
    {
        ...
        try
        {
            return DataContractUtility.TryParseBase64(input,SerializationData.ForType(typeof(GuidReferenceItem)),out item);
        }
    ...
    protected internal override async Task<Boolean> WipeDataCore(ManagementKey? managementkey, HashSet<Object> visited, CancellationToken cancel = default)
    {
        ...
        try
        {
            ...
            {
                await this.Next.WipeDataCore(managementkey,visited,cancel).ConfigureAwait(false); this.Next = null;
            }

            if(this.Previous is not null)
            {
                await this.Previous.WipeDataCore(managementkey,visited,cancel).ConfigureAwait(false); this.Previous = null;
            }

            if(this.UndirectedLinks is not null)
            {
                foreach(var _ in this.UndirectedLinks) { await _.WipeDataCore(managementkey,visited,cancel).ConfigureAwait(false); }
    ...
    protected internal override async Task<Boolean> WipeDataInMemoryOnlyCore(ManagementKey? managementkey , HashSet<Object> visited , Boolean requirelocks , CancellationToken cancel = default)
    {
        try
        {
            ...
            try
            {
                ...
                if(this.Next is not null)
                {
                    await this.Next.WipeDataInMemoryOnlyCore(managementkey,visited,true,cancel).ConfigureAwait(false); this.Next = null;
                }

                if(this.Previous is not null)
                {
                    await this.Previous.WipeDataInMemoryOnlyCore(managementkey,visited,true,cancel).ConfigureAwait(false); this.Previous = null;
                }

                if(this.UndirectedLinks is not null)
                {
                    foreach(var _ in this.UndirectedLinks) { await _.WipeDataInMemoryOnlyCore(managementkey,visited,true,cancel).ConfigureAwait(false); }
