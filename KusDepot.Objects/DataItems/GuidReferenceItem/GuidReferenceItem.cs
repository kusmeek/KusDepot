...
public sealed class GuidReferenceItem : DataItem , IComparable<GuidReferenceItem> , IEquatable<GuidReferenceItem> , IExtensibleDataObject , IParsable<GuidReferenceItem>
{
    ...
    public GuidReferenceItem? GetNext()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetNextFail,MyTypeName,MyID); throw; }
    }
    ...
    public GuidReferenceItem? GetPrevious()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetPreviousFail,MyTypeName,MyID); throw; }
    }
    ...
    public HashSet<GuidReferenceItem>? GetUndirectedLinks()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetUndirectedLinksFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return null; } throw; }
    }
    ...
    public Boolean SetNext(GuidReferenceItem? next , ManagementKey? managementkey = null)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,SetNextFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public Boolean SetPrevious(GuidReferenceItem? previous , ManagementKey? managementkey = null)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,SetPreviousFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public Boolean SetUndirectedLinks(IEnumerable<GuidReferenceItem>? undirectedlinks , ManagementKey? managementkey = null)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,SetUndirectedLinksFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
