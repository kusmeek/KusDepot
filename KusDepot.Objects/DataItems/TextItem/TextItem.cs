...
/**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/main/*'/>*/
[GenerateSerializer] [Alias("KusDepot.TextItem")]
[DataContract(Name = "TextItem" , Namespace = "KusDepot")]
public sealed class TextItem : DataItem , IComparable<TextItem> , IEquatable<TextItem> , IExtensibleDataObject , IParsable<TextItem>
{
    ...
    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/field[@name="Language"]/*'/>*/
    [DataMember(Name = "Language" , EmitDefaultValue = true , IsRequired = true)] [Id(1)]
    private String? Language;

    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/constructor[@name="ParameterlessConstructor"]/*'/>*/
    public TextItem() : this(null,null,null,null,null,null,null) {}

    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/constructor[@name="Constructor"]/*'/>*/
    public TextItem(String? content = null , String? file = null , Guid? id = null , String? name = null , IEnumerable<String>? notes = null , IEnumerable<String>? tags = null , String? type = null , String? language = null)
    {
        try
        {
            this.Sync = null!; this.Initialize(); this.SetContent(content); this.SetFILE(file); this.SetID(id); this.SetName(name); this.SetType(type); this.AddNotes(notes); this.AddTags(tags); this.SetLanguage(language);
        }
        catch ( Exception _ ) { Log.Error(_,ConstructorFail,MyTypeName,MyID); throw; }
    }
    ...
    public override async Task<Boolean> CheckDataHash(CancellationToken cancel = default)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,CheckDataHashFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }

    ///<inheritdoc/>
    public override Int32 CompareTo(IDataItem? other) { return other is TextItem t ? this.CompareTo(t) : base.CompareTo(other); }

    ///<inheritdoc/>
    public override Int32 CompareTo(DataItem? other) { return other is TextItem t ? this.CompareTo(t) : base.CompareTo(other); }

    ///<inheritdoc/>
    public override Int32 CompareTo(ICommon? other) { return other is TextItem t ? this.CompareTo(t) : base.CompareTo(other); }

    ///<inheritdoc/>
    public override Int32 CompareTo(Common? other) { return other is TextItem t ? this.CompareTo(t) : base.CompareTo(other); }
    ...
    public Int32 CompareTo(TextItem? other)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,CompareToFail,MyTypeName,MyID); throw; }
    }
    ...
    public override async Task<Boolean> DecryptData(ManagementKey? managementkey , CancellationToken cancel = default)
    {
        try
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    try
                    {
                        var i = this.EncryptedData; if(i is null) { return false; }
        ...
        catch ( Exception _ ) { Log.Error(_,DecryptDataFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public override async Task<Boolean> EncryptData(ManagementKey? managementkey , Boolean sign = true , CancellationToken cancel = default)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,EncryptDataFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }

    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/method[@name="op_Equality"]/*'/>*/
    public static Boolean operator ==(TextItem? a , TextItem? b) { return a is null ? b is null : a.Equals(b); }

    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/method[@name="op_Inequality"]/*'/>*/
    public static Boolean operator !=(TextItem? a , TextItem? b) { return !(a == b); }

    ///<inheritdoc/>
    public override Boolean Equals(IDataItem? other) { return this.Equals(other as TextItem); }

    ///<inheritdoc/>
    public override Boolean Equals(DataItem? other) { return this.Equals(other as TextItem); }

    ///<inheritdoc/>
    public override Boolean Equals(ICommon? other) { return this.Equals(other as TextItem); }

    ///<inheritdoc/>
    public override Boolean Equals(Common? other) { return this.Equals(other as TextItem); }

    ///<inheritdoc/>
    public override Boolean Equals(Object? other) { return this.Equals(other as TextItem); }
    ...
    public Boolean Equals(TextItem? other)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,EqualsFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }

    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/method[@name="FromFile"]/*'/>*/
    public static TextItem? FromFile(String path)
    {
        try
        {
            ...
            DataContractSerializer _1 = new(typeof(TextItem),new DataContractSerializerSettings(){MaxItemsInObjectGraph = Int32.MaxValue});

            using XmlDictionaryReader _2 = XmlDictionaryReader.CreateBinaryReader(_0,XmlDictionaryReaderQuotas.Max);

            return _1.ReadObject(_2) as TextItem;
        }
        catch ( Exception _ ) { Log.Error(_,FromFileFail); if(NoExceptions) { return null; } throw; }
    }

    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/method[@name="GetContent"]/*'/>*/
    public String? GetContent()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetContentFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return null; } throw; }
    }
        ...
        try
        {
            ...
            try
            {
                ...
                if(this.DataEncrypted && Array.Empty<Byte>().SequenceEqual(this.EncryptedData) is false)
                {
                    ...
                    if(d is not MemoryStream m) { return null; } return new () { Text = new(m.ToArray().ToUTF16StringFromByteArray()) };
                }

                return this.Content is not null ? new() { Text = new(this.Content) } : null;
            }
            finally { this.Sync.Data.Release(); }
        }
        catch ( Exception _ ) { Log.Error(_,GetDataContentFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return null; } throw; }
    ...
    public override Descriptor? GetDescriptor()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetDescriptorFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return null; } throw; }
    }
    ...
    public override Int32 GetHashCode()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetHashCodeFail,MyTypeName,MyID); throw; }
    }
    ...
    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/method[@name="GetLanguage"]/*'/>*/
    public String? GetLanguage()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetLanguageFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return null; } throw; }
    }

    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/method[@name="OnDeserialized"]/*'/>*/
    [OnDeserialized]
    public void OnDeserialized(StreamingContext context) { this.GetSyncNode(); this.RefreshSyncNodes(); }

    ///<inheritdoc/>
    static TextItem IParsable<TextItem>.Parse(String input , IFormatProvider? format) { return Parse(input,null)!; }

    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/method[@name="Parse"]/*'/>*/
    public static new TextItem? Parse(String input , IFormatProvider? format = null)
    {
        try
        {
            ...
            TextItem? _2 = _1.ReadObject(_0) as TextItem; if( _2 is not null ) { return _2; }
    ...
    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/method[@name="SetContent"]/*'/>*/
    public Boolean SetContent(String? content , ManagementKey? managementkey = null)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,SetContentFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public override Boolean SetContentStreamed(Boolean streamed , ManagementKey? managementkey = null)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,SetContentStreamedFail,MyTypeName,MyID); this.ContentStreamed = false; if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }

    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/method[@name="SetLanguage"]/*'/>*/
    public Boolean SetLanguage(String? language)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,SetLanguageFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }

    ///<inheritdoc/>
    public static Boolean TryParse([NotNullWhen(true)] String? input , IFormatProvider? format , [MaybeNullWhen(false)] out TextItem item)
    {
        ...
        try
        {
            ...
            TextItem? _2 = _1.ReadObject(_0) as TextItem; if( _2 is not null ) { item = _2; return true; }
    ...
    public override async Task<Boolean> VerifyData(String? field , ManagementKey? managementkey , CancellationToken cancel = default)
    {
            ...
            try
            {
                ...
                switch(field)
                {
                    case DataSecurityEDKey:
                    {
                        ...
                        return await VerifyDataCore(field,managementkey,this.EncryptedData,s,cancel).ConfigureAwait(false);
                    }
        ...
        catch ( Exception _ ) { Log.Error(_,VerifyDataFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public override async Task<Boolean> ZeroData(ManagementKey? managementkey = null , CancellationToken cancel = default)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,ZeroDataFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }

    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/property[@name="ExtensionData"]/*'/>*/
