...
public sealed class TextItem : DataItem , IComparable<TextItem> , IEquatable<TextItem> , IExtensibleDataObject , IParsable<TextItem>
{
    ...
    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/property[@name="MyContent"]/*'/>*/
    ...
    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/property[@name="MyLanguage"]/*'/>*/
    [JsonPropertyName("Language")] [JsonRequired] [IgnoreDataMember]
    public String? MyLanguage
    {
        get { try { return this.GetLanguage(); } catch { return null; } }

        set { try { this.SetLanguage(value); } catch {} }
    }
    ...
    public static TextItem? FromFile(String path)
    {
        try
        {
            ...
            return DataContractUtility.FromFile<TextItem>(path,SerializationData.ForType(typeof(TextItem)));
        }
    ...
    public static new TextItem? Parse(String input , IFormatProvider? format = null)
    {
        try
        {
            return DataContractUtility.ParseBase64<TextItem>(input,SerializationData.ForType(typeof(TextItem)));
        }
    ...
    public static Boolean TryParse([NotNullWhen(true)] String? input , IFormatProvider? format , [MaybeNullWhen(false)] out TextItem item)
    {
        ...
        try
        {
            return DataContractUtility.TryParseBase64(input,SerializationData.ForType(typeof(TextItem)),out item);
        }
