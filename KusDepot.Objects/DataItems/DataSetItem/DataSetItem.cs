...
public sealed class DataSetItem : DataItem , IComparable<DataSetItem> , IEquatable<DataSetItem> , IExtensibleDataObject , IParsable<DataSetItem>
{
    ...
    public Boolean AddDataItems(IEnumerable<DataItem>? data , ManagementKey? managementkey = null)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,AddDataItemsFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public DataItem? GetDataItem(Guid? id , ManagementKey? managementkey = null)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetDataItemFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return null; } throw; }
    }
    ...
    public HashSet<DataItem>? GetDataItems(ManagementKey? managementkey = null)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetDataItemsFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return null; } throw; }
    }
    ...
    public Boolean RemoveDataItem(Guid? id , ManagementKey? managementkey = null)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,RemoveDataItemFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
