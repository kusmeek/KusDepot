...
public sealed class KeySet : DataItem , IComparable<KeySet> , IEquatable<KeySet> , IParsable<KeySet>
{
    ...
    public Boolean AddKey(SecurityKey? key , String? name = null , ManagementKey? managementkey = null , Boolean sign = true)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,AddKeyFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public Boolean AddKeys(IEnumerable<SecurityKey>? keys , ManagementKey? managementkey = null , Boolean sign = true)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,AddKeysFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public Boolean CheckOwner(ManagementKey? managementkey)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,CheckOwnershipFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public Boolean ClearKeys(ManagementKey? managementkey = null)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,ClearKeysFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public OwnerKey? CreateOwnerKey(String? subject = null)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,CreateOwnerKeyFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return null; } throw; }
    }
    ...
    public Dictionary<String,SecurityKey>? GetAllKeys(ManagementKey? managementkey = null)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetAllKeysFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return null; } throw; }
    }
    ...
    public SecurityKey? GetKey(String? name , ManagementKey? managementkey = null)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetKeyFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return null; } throw; }
    }
    ...
    public Boolean ReleaseOwnership(ManagementKey? managementkey)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,ReleaseOwnershipFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public Boolean RemoveKey(String? name , ManagementKey? managementkey = null , Boolean sign = true)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,RemoveKeyFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public Boolean RemoveKeys(IEnumerable<SecurityKey>? keys , ManagementKey? managementkey = null , Boolean sign = true)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,RemoveKeysFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public Boolean TakeOwnership(ManagementKey? managementkey = null)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,TakeOwnershipFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
