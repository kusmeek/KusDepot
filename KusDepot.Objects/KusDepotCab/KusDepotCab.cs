...
[GenerateSerializer] [Alias("KusDepot.KusDepotCab")] [Immutable]
[JsonUnmappedMemberHandling(JsonUnmappedMemberHandling.Disallow)]

public sealed record class KusDepotCab : IEquatable<KusDepotCab> , IParsable<KusDepotCab>
{
    ...
    [JsonPropertyName("Cargo")] [JsonRequired]
    ...
    [JsonPropertyName("Manifest")] [JsonRequired]
    ...
    public DataItem? GetDataItem()
    {
        ...
        try
        {
            if(System.Type.GetType(this.Type)?.IsAssignableTo(typeof(KeySet)) ?? false )            { goto ReturnData; }
    ...
    {
        try { return JsonUtility.ToJsonString<KusDepotCab>(this); }

        catch ( Exception _ ) { KusDepotLog.Error(_,ToStringFail); return String.Empty; }
    }

    /**<include file='KusDepotCab.xml' path='KusDepotCab/record[@name="KusDepotCab"]/method[@name="Equals"]/*'/>*/
    public Boolean Equals(KusDepotCab? other) { return ReferenceEquals(this,other); }
    ...
    public static KusDepotCab? Parse(String input)
    {
        try { return String.IsNullOrEmpty(input) ? null : JsonUtility.Parse<KusDepotCab>(input); }
