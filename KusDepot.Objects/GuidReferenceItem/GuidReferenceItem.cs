...
public sealed class GuidReferenceItem : DataItem , ICloneable , IComparable<GuidReferenceItem> , IEquatable<GuidReferenceItem> , IExtensibleDataObject , IParsable<GuidReferenceItem>
{
    ...
    [DataMember(Name = "Next" , EmitDefaultValue = true , IsRequired = true)]
    ...
    [DataMember(Name = "Previous" , EmitDefaultValue = true , IsRequired = true)]
    private GuidReferenceItem? Previous;

    /**<include file='GuidReferenceItem.xml' path='GuidReferenceItem/class[@name="GuidReferenceItem"]/field[@name="Sync"]/*'/>*/
    [DataMember(Name = "GuidReferenceItemSync" , EmitDefaultValue = true , IsRequired = true)]
    private GuidReferenceItemSync Sync;

    /**<include file='GuidReferenceItem.xml' path='GuidReferenceItem/class[@name="GuidReferenceItem"]/field[@name="UndirectedLinks"]/*'/>*/
    [DataMember(Name = "UndirectedLinks" , EmitDefaultValue = true , IsRequired = true)]
    ...
    public GuidReferenceItem()
    {
        try
        {
            this.Sync = new GuidReferenceItemSync(); this.Type = DataType.GUID;
    ...
    public GuidReferenceItem(Guid? content = null , Guid? id = null , String? name = null , HashSet<String>? notes = null , HashSet<String>? tags = null)
    {
        try
        {
            this.Sync = new GuidReferenceItemSync(); this.Type = DataType.GUID;
    ...
    public override Object Clone()
    {
        try
        {
            GuidReferenceItem? _ = GuidReferenceItem.Parse(this.ToString(),null);
    ...
    public Int32 CompareTo(GuidReferenceItem? other)
    {
        try
        {
            ...
            Guid? _ = other.GetContent();

            if(this.Content is not null && _ is null)     { return 1; }
            if(this.Content is null     && _ is not null) { return -1; }

            if(this.Content.HasValue    && !_.HasValue)   { return 1; }
            if(!this.Content.HasValue   && _.HasValue)    { return -1; }

            if(this.Content!.Value == _!.Value)           { return 0; }

            if(this.Content.Value > _.Value)              { return 1; }
            else                                          { return -1; }
        }
        catch ( Exception ) { throw; }
    }
    ...
    public Boolean Equals(GuidReferenceItem? other)
    {
        try
        {
            ...
            return Guid.Equals(this.Content,other.GetContent());
        }
        catch ( Exception ) { if(NoExceptions) { return false; } throw; }
    }
    ...
    public static GuidReferenceItem? FromFile(String path)
    {
        try
        {
            ...
            using(FileStream _0 = new FileStream(path,new FileStreamOptions(){Access = FileAccess.Read , Mode = FileMode.Open , Options = FileOptions.SequentialScan , Share = FileShare.Read}))
            {
                ...
                {
                    DataContractSerializer _2 = new DataContractSerializer(typeof(GuidReferenceItem),new DataContractSerializerSettings(){MaxItemsInObjectGraph = Int32.MaxValue});

                    return (GuidReferenceItem?)_2.ReadObject(_1);
                }
            }
        }
    ...
    public Guid? GetContent() { return this.Content; }
    ...
    /**<include file='GuidReferenceItem.xml' path='GuidReferenceItem/class[@name="GuidReferenceItem"]/method[@name="GetDescriptor"]/*'/>*/
    public Descriptor? GetDescriptor()
    {
        try
        {
            return new Descriptor()
            {
                ...
                Name               = this.GetName(),
                Notes              = this.GetNotes(),
                ObjectType         = typeof(GuidReferenceItem).Name,
    ...
    public override Int32 GetHashCode() { return HashCode.Combine(this.Application,this.BornOn,this.Content,this.ID,this.Name); }
    ...
    public GuidReferenceItem? GetNext() { return this.Next is null ? null : (GuidReferenceItem)this.Next.Clone(); }
    ...
    public GuidReferenceItem? GetPrevious() { return this.Previous is null ? null : (GuidReferenceItem)this.Previous.Clone(); }
    ...
    public HashSet<GuidReferenceItem>? GetUndirectedLinks()
    {
        try
        {
            ...
            if(!TryEnter(this.Sync.UndirectedLinks,SyncTime)) { throw UndirectedLinksSyncException; }

            HashSet<GuidReferenceItem> _ = new(this.UndirectedLinks.Select(_=>(GuidReferenceItem)_.Clone()));

            if(!Equals(_.Count,this.UndirectedLinks.Count)) { return null; } return _;
        }
        catch ( Exception ) { if(NoExceptions) { return null; } throw; }

        finally { if(IsEntered(this.Sync.UndirectedLinks)) { Exit(this.Sync.UndirectedLinks); } }
    }
    ...
    [OnDeserialized]
    public void OnDeserialized(StreamingContext context) { this.Sync = new GuidReferenceItemSync(); }

    /**<include file='GuidReferenceItem.xml' path='GuidReferenceItem/class[@name="GuidReferenceItem"]/method[@name="Parse"]/*'/>*/
    public static GuidReferenceItem Parse(String input , IFormatProvider? format = null)
    {
        try
        {
            ...
            {
                DataContractSerializer _1 = new DataContractSerializer(typeof(GuidReferenceItem),new DataContractSerializerSettings(){MaxItemsInObjectGraph = Int32.MaxValue});

                GuidReferenceItem? _2 = (GuidReferenceItem?)_1.ReadObject(_0); if( _2 is not null ) { return _2; }

                throw new FormatException();
            }
        }
        catch ( Exception ) { if(NoExceptions) { return new GuidReferenceItem(); } throw; }
    }
    ...
    public Boolean SetContent(Guid? content)
    {
        try
        {
            ...
            if(Guid.Equals(content,Guid.Empty)) { this.Content = null; return true; }
    ...
    public Boolean SetNext(GuidReferenceItem? next)
    {
        try
        {
            if(this.Locked) { return false; }

            if(!TryEnter(this.Sync.Next,SyncTime)) { throw NextSyncException; }

            if(next is null) { this.Next = null; return true; }

            this.Next = (GuidReferenceItem)next.Clone(); return true;
        }
        catch ( Exception ) { if(NoExceptions) { return false; } throw; }

        finally { if(IsEntered(this.Sync.Next)) { Exit(this.Sync.Next); } }
    }

    /**<include file='GuidReferenceItem.xml' path='GuidReferenceItem/class[@name="GuidReferenceItem"]/method[@name="SetPrevious"]/*'/>*/
    public Boolean SetPrevious(GuidReferenceItem? previous)
    {
        try
        {
            if(this.Locked) { return false; }

            if(!TryEnter(this.Sync.Previous,SyncTime)) { throw PreviousSyncException; }

            if(previous is null) { this.Previous = null; return true; }

            this.Previous = (GuidReferenceItem)previous.Clone(); return true;
        }
        catch ( Exception ) { if(NoExceptions) { return false; } throw; }

        finally { if(IsEntered(this.Sync.Previous)) { Exit(this.Sync.Previous); } }
    }
    ...
    public Boolean SetUndirectedLinks(IEnumerable<GuidReferenceItem>? undirectedlinks)
    {
        try
        {
            if( undirectedlinks is null || this.Locked ) { return false; }

            HashSet<GuidReferenceItem> _ = new(undirectedlinks.Select(_=>(GuidReferenceItem)_.Clone()));

            if(!TryEnter(this.Sync.UndirectedLinks,SyncTime)) { throw UndirectedLinksSyncException; }

            if(Equals(_.Count,0)) { this.UndirectedLinks = null; return true; }

            this.UndirectedLinks = _; return true;
        }
        catch ( Exception ) { if(NoExceptions) { return false; } throw; }
    ...
    /**<include file='GuidReferenceItem.xml' path='GuidReferenceItem/class[@name="GuidReferenceItem"]/method[@name="ToFile"]/*'/>*/
    ...
    /**<include file='GuidReferenceItem.xml' path='GuidReferenceItem/class[@name="GuidReferenceItem"]/method[@name="ToString"]/*'/>*/
    ...
    /**<include file='GuidReferenceItem.xml' path='GuidReferenceItem/class[@name="GuidReferenceItem"]/method[@name="TryParse"]/*'/>*/
    public static Boolean TryParse([NotNullWhen(true)] String? input , IFormatProvider? format , [MaybeNullWhen(false)] out GuidReferenceItem item)
    {
        ...
        try
        {
            using(XmlDictionaryReader _0 = XmlDictionaryReader.CreateBinaryReader(input.ToByteArrayFromBase64(),XmlDictionaryReaderQuotas.Max))
            {
                ...
                GuidReferenceItem? _2 = (GuidReferenceItem?)_1.ReadObject(_0); if( _2 is not null ) { item = _2; return true; }
    ...
    public static Boolean Validate(GuidReferenceItem? item)
    {
        ...
        try { return new GuidReferenceItemValidator().Validate(item).IsValid; }

        catch ( Exception ) { if(NoExceptions) { return false; } throw; }
    }

    /**<include file='GuidReferenceItem.xml' path='GuidReferenceItem/class[@name="GuidReferenceItem"]/method[@name="AcquireLocks"]/*'/>*/
    ...
    /**<include file='GuidReferenceItem.xml' path='GuidReferenceItem/class[@name="GuidReferenceItem"]/method[@name="ReleaseLocks"]/*'/>*/
    private void ReleaseLocks()
    {
        if(IsEntered(this.Sync.Version))            { Exit(this.Sync.Version); }
        if(IsEntered(this.Sync.UndirectedLinks))    { Exit(this.Sync.UndirectedLinks); }
        ...
        if(IsEntered(this.Sync.ProcessID))          { Exit(this.Sync.ProcessID); }
        if(IsEntered(this.Sync.Previous))           { Exit(this.Sync.Previous); }
        if(IsEntered(this.Sync.Notes))              { Exit(this.Sync.Notes); }
        if(IsEntered(this.Sync.Next))               { Exit(this.Sync.Next); }
...
public class GuidReferenceItemValidator : AbstractValidator<GuidReferenceItem>
{
    ...
    public GuidReferenceItemValidator()
    {
        ...
        this.RuleFor( (item) => item.GetType()).Equal(DataType.GUID);
    }
}