...
public static class ReflectionBindingScore
{
    ...
    public static Int32 Compare(Int32 length , Int32 exact , Int32 assignable , Boolean isstatic , Int32 bestLength , Int32 bestExact , Int32 bestAssignable , Boolean? bestStatic , Boolean preferInstanceOnTie)
    {
        try
        {
