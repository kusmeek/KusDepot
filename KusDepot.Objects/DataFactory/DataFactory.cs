...
public static class DataFactory
{
    ...
    /**<include file='DataFactory.xml' path='DataFactory/class[@name="DataFactory"]/method[@name="CreateDataStreamItem"]/*'/>*/
    public static DataStreamItem? CreateDataStreamItem(Stream? content = null , Guid? id = null , String? name = null , IEnumerable<String>? notes = null , IEnumerable<String>? tags = null , String? type = null)
    {
        try { return new DataStreamItem(content,id,name,notes,tags,type); }

        catch ( Exception _ ) { KusDepotLog.Error(_,CreateDataStreamItemFail); if(NoExceptions) { return null; } throw; }
    }

    /**<include file='DataFactory.xml' path='DataFactory/class[@name="DataFactory"]/method[@name="CreateDataStreamItemAction"]/*'/>*/
    public static DataStreamItem? CreateDataStreamItem(Action<DataStreamItem>? configure = null)
    {
        try { DataStreamItem _ = new(); configure?.Invoke(_); return _; }

        catch ( Exception _ ) { KusDepotLog.Error(_,CreateDataStreamItemFail); if(NoExceptions) { return null; } throw; }
    }

    /**<include file='DataFactory.xml' path='DataFactory/class[@name="DataFactory"]/method[@name="CreateDataStreamItemActionAsync"]/*'/>*/
    public static async Task<DataStreamItem?> CreateDataStreamItemAsync(Func<DataStreamItem,Task>? configure = null)
    {
        try { DataStreamItem _ = new(); if(configure is not null) { await configure(_).ConfigureAwait(false); } return _; }
