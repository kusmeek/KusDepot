...
public class ToolGenericHost : ToolHost , IToolGenericHost
{
    ...
    public ToolGenericHost(IAccessManager? accessmanager = null , IEnumerable<DataItem>? data = null , Guid? id = null , ToolServiceProvider? services = null , Dictionary<String,ICommand>? commands = null , IConfiguration? configuration = null,
           IHost? host = null , Guid? lifeid = null , IToolHostLifetime? lifetime = null , ILogger? logger = null ) : base(accessmanager,data,id,services,commands,configuration,lifeid,lifetime,logger)
    {
        try
        {
    ...
    protected override Boolean ResolveLogger(Serilog.ILogger? logger = null)
    {
        ...
        try
        {
            ...
            this.Logger = logger ?? this.Host?.Services.GetService<Serilog.ILogger>() ?? this.ToolServices?.GetService<Serilog.ILogger>();
