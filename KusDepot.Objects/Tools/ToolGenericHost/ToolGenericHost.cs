...
public class ToolGenericHost : ToolHost , IToolGenericHost
{
    ...
    public ToolGenericHost(IAccessManager? accessmanager = null , IEnumerable<DataItem>? data = null , Guid? id = null , IEnumerable<Meta<ICommand>>? commands = null , IConfiguration? configuration = null,
           IContainer? container = null , IHost? host = null , IEnumerable<Object>? inputs = null , Guid? lifeid = null , IToolHostLifetime? lifetime = null , ILogger? logger = null ):
           base(accessmanager:accessmanager,data:data,id:id,commands:commands,configuration:configuration,container:container,inputs:inputs,lifeid:lifeid,lifetime:lifetime,logger:logger)
    {
        try
        {
            this.Host = host; this.Services = this.Host?.Services ?? this.ToolServices;
    ...
    public ToolGenericHost() : this(null,null,null,null,null,null,null,null,null,null,null){}
    ...
    protected override Boolean ResolveLogger(Serilog.ILogger? logger = null)
    {
        ...
        try
        {
            ...
            this.Logger = logger ?? this.Host?.Services.GetService<Serilog.ILogger>() ?? this.GetContainerScope()?.ResolveOptional<Serilog.ILogger>();
