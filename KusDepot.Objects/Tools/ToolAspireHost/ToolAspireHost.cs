...
public class ToolAspireHost : ToolHost , IToolAspireHost
{
    ...
    public ToolAspireHost(IAccessManager? accessmanager = null , IEnumerable<DataItem>? data = null , Guid? id = null , IEnumerable<Meta<ICommand>>? commands = null , IConfiguration? configuration = null,
           IContainer? container = null , IEnumerable<Object>? inputs = null , Guid? lifeid = null , IToolHostLifetime? lifetime = null , ILogger? logger = null , IHost? aspireapplication = null):
           base(accessmanager:accessmanager,data:data,id:id,commands:commands,configuration:configuration,container:container,inputs:inputs,lifeid:lifeid,lifetime:lifetime,logger:logger)
    {
        try
        {
            ...
            this.Services = this.AspireApplication?.Services ?? this.ToolServices; this.ResolveLogger(logger);
        }
    ...
    public ToolAspireHost() : this(null,null,null,null,null,null,null,null,null,null,null){}
    ...
    protected override Boolean ResolveLogger(Serilog.ILogger? logger = null)
    {
        ...
        try
        {
            ...
            this.Logger = logger ?? this.AspireApplication?.Services.GetService<Serilog.ILogger>() ?? this.GetContainerScope()?.ResolveOptional<Serilog.ILogger>();
