...
public class ToolHostLifetime : IToolHostLifetime
{
    ...
    public void NotifyStarting(Guid lifeid)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,NotifyStartingFail,this.LifeID.ToString()); if(NoExceptions) { return; } throw; }
    }
    ...
    public void NotifyStarted(Guid lifeid)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,NotifyStartedFail,this.LifeID.ToString()); if(NoExceptions) { return; } throw; }
    }
    ...
    public void NotifyStopping(Guid lifeid)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,NotifyStoppingFail,this.LifeID.ToString()); if(NoExceptions) { return; } throw; }
    }
    ...
    public void NotifyStopped(Guid lifeid)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,NotifyStoppedFail,this.LifeID.ToString()); if(NoExceptions) { return; } throw; }
    }
    ...
    public virtual void Dispose()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,DisposeFail,this.GetType().Name,this.LifeID.ToString()); }
    }
