...
public class ToolHost : Tool , IToolHost
{
    ...
    ///<inheritdoc/>
    [NotNull]
    public IServiceProvider? Services { get { return this.GetLocked() is true ? null! : field!; } protected set; }

    ///<inheritdoc/>
    public IServiceProvider? ToolServices { get { return this.GetLocked() is true ? null! : field!; } protected set; }

    /**<include file='ToolHost.xml' path='ToolHost/class[@name="ToolHost"]/constructor[@name="Constructor"]/*'/>*/
    public ToolHost(IAccessManager? accessmanager = null , IEnumerable<DataItem>? data = null , Guid? id = null , IEnumerable<Meta<ICommand>>? commands = null,
           IConfiguration? configuration = null , IContainer? container = null , IEnumerable<Object>? inputs = null , Guid? lifeid = null , IToolHostLifetime? lifetime = null , ILogger? logger = null):
           base(accessmanager:accessmanager,data:data,id:id,commands:commands,configuration:configuration,container:container,inputs:inputs,logger:logger)
    {
        try
        {
            ...
            this.Services = this.ToolServices = new AutofacServiceProvider(this.GetContainerScope(SelfAccessKey)!);
        }
    ...
    public ToolHost() : this(null,null,null,null,null,null,null,null,null,null){}
