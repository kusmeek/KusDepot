...
public interface IToolHost : IHost , ITool
{
    ...
    /**<include file='IToolHost.xml' path='IToolHost/interface[@name="IToolHost"]/property[@name="ToolServices"]/*'/>*/
    IServiceProvider? ToolServices { get; }
    ...
    /**<include file='IToolHost.xml' path='IToolHost/interface[@name="IToolHost"]/method[@name="GetToolServices"]/*'/>*/
    IServiceProvider? GetToolServices(AccessKey? key);
