...
public class ToolWebHost : ToolHost , IToolWebHost
{
    ...
    public ToolWebHost(IAccessManager? accessmanager = null , IEnumerable<DataItem>? data = null , Guid? id = null , ToolServiceProvider? services = null , Dictionary<String,ICommand>? commands = null , IConfiguration? configuration = null,
           Guid? lifeid = null , IToolHostLifetime? lifetime = null , ILogger? logger = null , ICollection<String>? urls = null , IHost? webapplication = null) : base(accessmanager,data,id,services,commands,configuration,lifeid,lifetime,logger)
    {
        try
        {
    ...
    protected override Boolean ResolveLogger(Serilog.ILogger? logger = null)
    {
        ...
        try
        {
            ...
            this.Logger = logger ?? this.WebApplication?.Services.GetService<Serilog.ILogger>() ?? this.ToolServices?.GetService<Serilog.ILogger>();
