...
public class ToolWebHost : ToolHost , IToolWebHost
{
    ...
    public ToolWebHost(IAccessManager? accessmanager = null , IEnumerable<DataItem>? data = null , Guid? id = null , IEnumerable<Meta<ICommand>>? commands = null , IConfiguration? configuration = null , IContainer? container = null,
           IEnumerable<Object>? inputs = null , Guid? lifeid = null , IToolHostLifetime? lifetime = null , ILogger? logger = null , ICollection<String>? urls = null , IHost? webapplication = null):
           base(accessmanager:accessmanager,data:data,id:id,commands:commands,configuration:configuration,container:container,inputs:inputs,lifeid:lifeid,lifetime:lifetime,logger:logger)
    {
        try
        {
            this.Urls = urls?.ToArray(); this.WebApplication = webapplication;

            this.Services = this.WebApplication?.Services ?? this.ToolServices; this.ResolveLogger(logger);
        }
    ...
    public ToolWebHost() : this(null,null,null,null,null,null,null,null,null,null,null,null){}
    ...
    ///<inheritdoc/>
    protected override Boolean ResolveLogger(Serilog.ILogger? logger = null)
    {
        DC();
        try
        {
            ...
            this.Logger = logger ?? this.WebApplication?.Services.GetService<Serilog.ILogger>() ?? this.GetContainerScope()?.ResolveOptional<Serilog.ILogger>();
