...
public sealed class TextItem : DataItem , ICloneable , IComparable<TextItem> , IEquatable<TextItem> , IExtensibleDataObject , IParsable<TextItem>
{
    ...
    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/field[@name="Sync"]/*'/>*/
    [DataMember(Name = "TextItemSync" , EmitDefaultValue = true , IsRequired = true)]
    private TextItemSync Sync;
    ...
    public TextItem(String? content = null , Guid? id = null , String? name = null , HashSet<String>? notes = null , HashSet<String>? tags = null , String? type = null)
    {
        try
        {
            this.Sync = new TextItemSync();
    ...
    public override Object Clone()
    {
        try
        {
            TextItem? _ = TextItem.Parse(this.ToString(),null);
    ...
    public Boolean Equals(TextItem? other)
    {
        try
        {
            ...
            return String.Equals(this.GetContent(),other.GetContent(),StringComparison.Ordinal);
        }
        catch ( Exception ) { if(NoExceptions) { return false; } throw; }
    }
    ...
    public static TextItem? FromFile(String path)
    {
        try
        {
            ...
            using(FileStream _0 = new FileStream(path,new FileStreamOptions(){Access = FileAccess.Read , Mode = FileMode.Open , Options = FileOptions.SequentialScan , Share = FileShare.Read}))
            {
                ...
                {
                    DataContractSerializer _2 = new DataContractSerializer(typeof(TextItem),new DataContractSerializerSettings(){MaxItemsInObjectGraph = Int32.MaxValue});

                    return (TextItem?)_2.ReadObject(_1);
                }
            }
        }
    ...
    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/method[@name="GetDescriptor"]/*'/>*/
    public Descriptor? GetDescriptor()
    {
        try
        {
            return new Descriptor()
            {
                ...
                Name               = this.GetName(),
                Notes              = this.GetNotes(),
                ObjectType         = typeof(TextItem).Name,
    ...
    [OnDeserialized]
    public void OnDeserialized(StreamingContext context) { this.Sync = new TextItemSync(); }

    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/method[@name="Parse"]/*'/>*/
    public static TextItem Parse(String input , IFormatProvider? format = null)
    {
        try
        {
            ...
            {
                DataContractSerializer _1 = new DataContractSerializer(typeof(TextItem),new DataContractSerializerSettings(){MaxItemsInObjectGraph = Int32.MaxValue});

                TextItem? _2 = (TextItem?)_1.ReadObject(_0); if( _2 is not null ) { return _2; }

                throw new FormatException();
            }
        }
        catch ( Exception ) { if(NoExceptions) { return new TextItem(); } throw; }
    }
    ...
    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/method[@name="ToFile"]/*'/>*/
    ...
    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/method[@name="ToString"]/*'/>*/
    ...
    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/method[@name="TryParse"]/*'/>*/
    public static Boolean TryParse([NotNullWhen(true)] String? input , IFormatProvider? format , [MaybeNullWhen(false)] out TextItem item)
    {
        ...
        try
        {
            using(XmlDictionaryReader _0 = XmlDictionaryReader.CreateBinaryReader(input.ToByteArrayFromBase64(),XmlDictionaryReaderQuotas.Max))
            {
                ...
                TextItem? _2 = (TextItem?)_1.ReadObject(_0); if( _2 is not null ) { item = _2; return true; }
    ...
    public static Boolean Validate(TextItem? item)
    {
        ...
        try { return new TextItemValidator().Validate(item).IsValid; }

        catch ( Exception ) { if(NoExceptions) { return false; } throw; }
    }

    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/method[@name="AcquireLocks"]/*'/>*/
    ...
    /**<include file='TextItem.xml' path='TextItem/class[@name="TextItem"]/method[@name="ReleaseLocks"]/*'/>*/
...
public class TextItemValidator : AbstractValidator<TextItem>
{
    ...
    public TextItemValidator()
    {
        ...
        this.RuleFor( (item) => item.GetType()).NotNull().NotEmpty().Must( (item,String) => { return TextItemValidDataTypes.Contains(item.GetType()); } );
    }
}