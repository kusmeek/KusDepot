...
public abstract class Common : ICommon , IComparable<Common> , IEquatable<Common>
{
    ...
    public virtual Boolean CheckManager(ManagementKey? managementkey)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,CheckManagerFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    ...
    protected virtual Boolean CheckRemoveSecret(Byte[]? certificate , ICollection<Byte[]>? secrets)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,CheckRemoveSecretFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    protected virtual Boolean CheckSecret(Byte[]? certificate , ReadOnlySpan<Byte> secret)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,CheckSecretFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    protected virtual Boolean CheckSecrets(Byte[]? certificate , ICollection<Byte[]>? secrets)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,CheckSecretsFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public virtual Int32 CompareTo(Common? other)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,CompareToFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return Int32.MinValue; } throw; }
    }
    ...
    protected virtual Byte[]? CreateSecret(Byte[]? certificate)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,CreateSecretFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return null; } throw; }
    ...
    public virtual Boolean DisableMyExceptions()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,DisableMyExceptionsFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public virtual Boolean EnableMyExceptions()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,EnableMyExceptionsFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw; }
    }
    ...
    public virtual Guid? GetID()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetIDFail,MyTypeName,MyID); throw; }
    }
    ...
    public virtual Boolean GetLocked()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,GetLockedFail,MyTypeName,MyID); throw; }
    }
    ...
    public virtual Boolean Lock(ManagementKey? managementkey)
    {
        ...
        catch ( Exception _ )
        {
            ...
            this.Locked = false; Log.Error(_,LockFail,MyTypeName,MyID); if(NoExceptions||MyNoExceptions) { return false; } throw;
        }
