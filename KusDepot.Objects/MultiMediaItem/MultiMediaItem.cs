...
public sealed class MultiMediaItem : DataItem , ICloneable , IComparable<MultiMediaItem> , IEquatable<MultiMediaItem> , IExtensibleDataObject , IParsable<MultiMediaItem>
{
    /**<include file='MultiMediaItem.xml' path='MultiMediaItem/class[@name="MultiMediaItem"]/property[@name="Artists"]/*'/>*/
    [DataMember(Name = "Artists" , EmitDefaultValue = true , IsRequired = true)]
    ...
    [DataMember(Name = "Bitrate" , EmitDefaultValue = true , IsRequired = true)]
    ...
    [DataMember(Name = "Duration" , EmitDefaultValue = true , IsRequired = true)]
    private Decimal? Duration;

    /**<include file='MultiMediaItem.xml' path='MultiMediaItem/class[@name="MultiMediaItem"]/property[@name="Framerate"]/*'/>*/
    [DataMember(Name = "Framerate" , EmitDefaultValue = true , IsRequired = true)]
    ...
    [DataMember(Name = "Language" , EmitDefaultValue = true , IsRequired = true)]
    ...
    /**<include file='MultiMediaItem.xml' path='MultiMediaItem/class[@name="MultiMediaItem"]/field[@name="Sync"]/*'/>*/
    [DataMember(Name = "MultiMediaItemSync" , EmitDefaultValue = true , IsRequired = true)]
    private MultiMediaItemSync Sync;
    ...
    /**<include file='MultiMediaItem.xml' path='MultiMediaItem/class[@name="MultiMediaItem"]/property[@name="Year"]/*'/>*/
    ...
    public MultiMediaItem()
    {
        try
        {
            this.Sync = new MultiMediaItemSync();
    ...
    public MultiMediaItem(Byte[]? content = null , Guid? id = null , String? name = null , HashSet<String>? artists = null , HashSet<String>? notes = null , HashSet<String>? tags = null , String? title = null , String? type = null , Int32? year = null)
    {
        try
        {
            this.Sync = new MultiMediaItemSync();

            this.SetContent(content); this.SetID(id); this.SetName(name); this.SetArtists(artists); this.AddNotes(notes); this.AddTags(tags); this.SetTitle(title); this.SetType(type); this.SetYear(year);
    ...
    public override Object Clone()
    {
        try
        {
            MultiMediaItem? _ = MultiMediaItem.Parse(this.ToString(),null);
    ...
    public static MultiMediaItem? FromFile(String path)
    {
        try
        {
            ...
            using(FileStream _0 = new FileStream(path,new FileStreamOptions(){Access = FileAccess.Read , Mode = FileMode.Open , Options = FileOptions.SequentialScan , Share = FileShare.Read}))
            {
                ...
                {
                    DataContractSerializer _2 = new DataContractSerializer(typeof(MultiMediaItem),new DataContractSerializerSettings(){MaxItemsInObjectGraph = Int32.MaxValue});

                    return (MultiMediaItem?)_2.ReadObject(_1);
                }
            }
        }
    ...
    public HashSet<String>? GetArtists()
    {
        try
        {
            ...
            if(!TryEnter(this.Sync.Artists,SyncTime)) { throw ArtistsSyncException; }

            HashSet<String> _ = new HashSet<String>(); _.UnionWith(this.Artists.Select(_=>new String(_))); return _;
        }
        catch ( Exception ) { if(NoExceptions) { return null; } throw; }

        finally { if(IsEntered(this.Sync.Artists)) { Exit(this.Sync.Artists); } }
    }
    ...
    public Double? GetBitrate() { return this.Bitrate; }
    ...
    /**<include file='MultiMediaItem.xml' path='MultiMediaItem/class[@name="MultiMediaItem"]/method[@name="GetDescriptor"]/*'/>*/
    public Descriptor? GetDescriptor()
    {
        try
        {
            return new Descriptor()
            {
                ...
                Name               = this.GetName(),
                Notes              = this.GetNotes(),
                ObjectType         = typeof(MultiMediaItem).Name,
                ServiceVersion     = this.GetServiceVersion()?.ToString(),
                Tags               = this.GetTags(),
                Type               = this.GetType(),
                Version            = this.GetVersion()?.ToString(),
                Year               = this.GetYear()?.ToString(CultureInfo.InvariantCulture)
            };
        }
        catch ( Exception ) { if(NoExceptions) { return null; } throw; }
    }
    ...
    public Decimal? GetDuration() { return this.Duration; }
    ...
    public Single? GetFramerate() { return this.Framerate; }
    ...
    public String? GetLanguage() { return this.Language is null ? null : new String(this.Language); }
    ...
    public Stream? GetSource() { return this.Locked ? null : this.Source; }
    ...
    public String? GetTitle() { return this.Title is null ? null : new String(this.Title); }
    ...
    public Int32? GetYear() { return this.Year; }
    ...
    [OnDeserialized]
    public void OnDeserialized(StreamingContext context) { this.Sync = new MultiMediaItemSync(); }

    /**<include file='MultiMediaItem.xml' path='MultiMediaItem/class[@name="MultiMediaItem"]/method[@name="Parse"]/*'/>*/
    public static MultiMediaItem Parse(String input , IFormatProvider? format = null)
    {
        try
        {
            ...
            {
                DataContractSerializer _1 = new DataContractSerializer(typeof(MultiMediaItem),new DataContractSerializerSettings(){MaxItemsInObjectGraph = Int32.MaxValue});

                MultiMediaItem? _2 = (MultiMediaItem?)_1.ReadObject(_0); if( _2 is not null ) { return _2; }

                throw new FormatException();
            }
        }
        catch ( Exception ) { if(NoExceptions) { return new MultiMediaItem(); } throw; }
    }
    ...
    public Boolean SetArtists(IEnumerable<String>? artists)
    {
        try
        {
            ...
            if(Equals(_.Count,0)) { this.Artists = null; return true; }

            this.Artists = _; return true;
        }
        catch ( Exception ) { if(NoExceptions) { return false; } throw; }
    ...
    public Boolean SetBitrate(Double? bitrate)
    {
        try
        {
            ...
            if(!TryEnter(this.Sync.Bitrate,SyncTime)) { throw BitrateSyncException; }

            if(Double.Equals(bitrate,0)) { this.Bitrate = null; return true; }

            this.Bitrate = bitrate; return true;
        }
        catch ( Exception ) { if(NoExceptions) { return false; } throw; }

        finally { if(IsEntered(this.Sync.Bitrate)) { Exit(this.Sync.Bitrate); } }
    }
    ...
    public Boolean SetDuration(Decimal? duration)
    {
        try
        {
            ...
            if(!TryEnter(this.Sync.Duration,SyncTime)) { throw DurationSyncException; }

            if(Decimal.Equals(duration,0)) { this.Duration = null; return true; }

            this.Duration = duration; return true;
        }
        catch ( Exception ) { if(NoExceptions) { return false; } throw; }

        finally { if(IsEntered(this.Sync.Duration)) { Exit(this.Sync.Duration); } }
    }
    ...
    public Boolean SetFramerate(Single? framerate)
    {
        try
        {
            ...
            if(!TryEnter(this.Sync.Framerate,SyncTime)) { throw FramerateSyncException; }

            if(Single.Equals(framerate,0)) { this.Framerate = null; return true; }

            this.Framerate = framerate; return true;
        }
        catch ( Exception ) { if(NoExceptions) { return false; } throw; }

        finally { if(IsEntered(this.Sync.Framerate)) { Exit(this.Sync.Framerate); } }
    }
    ...
    public Boolean SetLanguage(String? language)
    {
        try
        {
            ...
            if(!TryEnter(this.Sync.Language,SyncTime)) { throw LanguageSyncException; }

            if(String.IsNullOrEmpty(language)) { this.Language = null; return true; }

            this.Language = new String(language); return true;
        }
        catch ( Exception ) { if(NoExceptions) { return false; } throw; }

        finally { if(IsEntered(this.Sync.Language)) { Exit(this.Sync.Language); } }
    }
    ...
    public Boolean SetSource(Stream? source)
    {
        try
        {
            ...
            if(!TryEnter(this.Sync.Source,SyncTime)) { throw SourceSyncException; }

            this.Source = source; return true;
        }
        catch ( Exception ) { if(NoExceptions) { return false; } throw; }

        finally { if(IsEntered(this.Sync.Source)) { Exit(this.Sync.Source); } }
    }
    ...
    public Boolean SetTitle(String? title)
    {
        try
        {
            ...
            if(!TryEnter(this.Sync.Title,SyncTime)) { throw TitleSyncException; }

            if(String.IsNullOrEmpty(title)) { this.Title = null; return true; }

            this.Title = new String(title); return true;
        }
        catch ( Exception ) { if(NoExceptions) { return false; } throw; }

        finally { if(IsEntered(this.Sync.Title)) { Exit(this.Sync.Title); } }
    }
    ...
    public Boolean SetYear(Int32? year)
    {
        try
        {
            ...
            if(!TryEnter(this.Sync.Year,SyncTime)) { throw YearSyncException; }

            if(Equals(year,0)) { this.Year = null; return true; }

            this.Year = year; return true;
        }
        catch ( Exception ) { if(NoExceptions) { return false; } throw; }

        finally { if(IsEntered(this.Sync.Year)) { Exit(this.Sync.Year); } }
    }

    /**<include file='MultiMediaItem.xml' path='MultiMediaItem/class[@name="MultiMediaItem"]/method[@name="ToFile"]/*'/>*/
    ...
    /**<include file='MultiMediaItem.xml' path='MultiMediaItem/class[@name="MultiMediaItem"]/method[@name="ToString"]/*'/>*/
    ...
    /**<include file='MultiMediaItem.xml' path='MultiMediaItem/class[@name="MultiMediaItem"]/method[@name="TryParse"]/*'/>*/
    public static Boolean TryParse([NotNullWhen(true)] String? input , IFormatProvider? format , [MaybeNullWhen(false)] out MultiMediaItem item)
    {
        ...
        try
        {
            using(XmlDictionaryReader _0 = XmlDictionaryReader.CreateBinaryReader(input.ToByteArrayFromBase64(),XmlDictionaryReaderQuotas.Max))
            {
                ...
                MultiMediaItem? _2 = (MultiMediaItem?)_1.ReadObject(_0); if( _2 is not null ) { item = _2; return true; }
    ...
    public static Boolean Validate(MultiMediaItem? item)
    {
        ...
        try { return new MultiMediaItemValidator().Validate(item).IsValid; }

        catch ( Exception ) { if(NoExceptions) { return false; } throw; }
    }

    /**<include file='MultiMediaItem.xml' path='MultiMediaItem/class[@name="MultiMediaItem"]/method[@name="AcquireLocks"]/*'/>*/
    ...
    /**<include file='MultiMediaItem.xml' path='MultiMediaItem/class[@name="MultiMediaItem"]/method[@name="ReleaseLocks"]/*'/>*/
    private void ReleaseLocks()
    {
        if(IsEntered(this.Sync.Year))               { Exit(this.Sync.Year); }
        if(IsEntered(this.Sync.Version))            { Exit(this.Sync.Version); }
        if(IsEntered(this.Sync.Type))               { Exit(this.Sync.Type); }
        if(IsEntered(this.Sync.Title))              { Exit(this.Sync.Title); }
        if(IsEntered(this.Sync.ThreadID))           { Exit(this.Sync.ThreadID); }
        ...
        if(IsEntered(this.Sync.Source))             { Exit(this.Sync.Source); }
        ...
        if(IsEntered(this.Sync.Language))           { Exit(this.Sync.Language); }
        if(IsEntered(this.Sync.ID))                 { Exit(this.Sync.ID); }
        if(IsEntered(this.Sync.GPS))                { Exit(this.Sync.GPS); }
        if(IsEntered(this.Sync.Framerate))          { Exit(this.Sync.Framerate); }
        if(IsEntered(this.Sync.FILE))               { Exit(this.Sync.FILE); }
        if(IsEntered(this.Sync.Extension))          { Exit(this.Sync.Extension); }
        if(IsEntered(this.Sync.Duration))           { Exit(this.Sync.Duration); }
        ...
        if(IsEntered(this.Sync.BornOn))             { Exit(this.Sync.BornOn); }
        if(IsEntered(this.Sync.Bitrate))            { Exit(this.Sync.Bitrate); }
        if(IsEntered(this.Sync.AssemblyVersion))    { Exit(this.Sync.AssemblyVersion); }
        if(IsEntered(this.Sync.Artists))            { Exit(this.Sync.Artists); }
...
public class MultiMediaItemValidator : AbstractValidator<MultiMediaItem>
{
    ...
    public MultiMediaItemValidator()
    {
        ...
        this.RuleFor( (item) => item.GetType()).NotNull().NotEmpty().Must( (item,String) => { return MultiMediaItemValidDataTypes.Contains(item.GetType()); } );
    }
}