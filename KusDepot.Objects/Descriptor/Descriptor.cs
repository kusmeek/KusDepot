...
public sealed record class Descriptor : IEquatable<Descriptor> , IParsable<Descriptor>
{
    ...
    [DataMember(Name = "ContentStreamed" , EmitDefaultValue = true , IsRequired = true)] [Id(5)]
    ...
    [DataMember(Name = "DataType" , EmitDefaultValue = true , IsRequired = true)] [Id(6)]
    ...
    /**<include file='Descriptor.xml' path='Descriptor/record[@name="Descriptor"]/property[@name="ObjectFILE"]/*'/>*/
    [JsonPropertyName("ObjectFILE")] [JsonRequired]
    ...
    [DataMember(Name = "Version" , EmitDefaultValue = true , IsRequired = true)] [Id(20)]
    ...
    [DataMember(Name = "Year" , EmitDefaultValue = true , IsRequired = true)] [Id(21)]
...
public static class DescriptorExtensions
{
    ...
    public static Boolean IsDataItem(this Descriptor descriptor)
    {
        return new String[]
        {
            ...
            typeof(DataStreamItem).FullName!,
    ...
    /**<include file='Descriptor.xml' path='Descriptor/class[@name="DescriptorExtensions"]/method[@name="IsDataStreamItem"]/*'/>*/
    public static Boolean IsDataStreamItem(this Descriptor descriptor)
    {
        return new String[]
        {
            typeof(DataStreamItem).FullName!,
