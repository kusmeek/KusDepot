...
public sealed record Descriptor
{
    ...
    public static Descriptor? Parse(String input) { try { return String.IsNullOrEmpty(input) ? null : JsonSerializer.Deserialize<Descriptor>(input); } catch ( Exception _ ) { Log.Error(_,ParseFail); return null; } }
}
