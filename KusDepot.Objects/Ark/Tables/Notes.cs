...
/**<include file='Notes.xml' path='Notes/class[@name="Notes"]/main/*'/>*/
internal sealed class Notes : DataTable
{
    /**<include file='Notes.xml' path='Notes/class[@name="Notes"]/constructor[@name="Constructor"]/*'/>*/
    internal Notes(String? name , Int32 capacity) : base(name)
    {
        DataColumn? _0;

        _0 = this.Columns.Add("ID",typeof(Guid)); _0.AllowDBNull = false; _0.DefaultValue = null; _0.Unique = true;

        for( Int32 _n = 0 ; _n < capacity ; _n++ ) { _0 = this.Columns.Add("Note" + _n.ToString(CultureInfo.InvariantCulture),typeof(String)); _0.AllowDBNull = true; _0.DefaultValue = null; }

        this.PrimaryKey = new DataColumn[] { this.Columns["ID"]! };
    }

    /**<include file='Notes.xml' path='Notes/class[@name="Notes"]/method[@name="AddUpdate"]/*'/>*/
    internal Boolean AddUpdate(String? it)
    {
        ...
        Object[] _u = new Object[this.GetNoteCapacity()+1];
        ...
        try
        {
            ...
            GetData:
            if(_0 is not null) { _u.SetValue(_0.GetID(),0); String[]? _t = _0.GetNotes()?.ToArray(); if( _t is null ) { goto AddUpdate; } if(this.GetNoteCapacity() < _t.Length) { return false; } for(Int32 _ = 0; _ < _t.Length; _++) { _u.SetValue(_t[_],_+1); } }
            if(_1 is not null) { _u.SetValue(_1.GetID(),0); String[]? _t = _1.GetNotes()?.ToArray(); if( _t is null ) { goto AddUpdate; } if(this.GetNoteCapacity() < _t.Length) { return false; } for(Int32 _ = 0; _ < _t.Length; _++) { _u.SetValue(_t[_],_+1); } }
            if(_2 is not null) { _u.SetValue(_2.GetID(),0); String[]? _t = _2.GetNotes()?.ToArray(); if( _t is null ) { goto AddUpdate; } if(this.GetNoteCapacity() < _t.Length) { return false; } for(Int32 _ = 0; _ < _t.Length; _++) { _u.SetValue(_t[_],_+1); } }
            if(_3 is not null) { _u.SetValue(_3.GetID(),0); String[]? _t = _3.GetNotes()?.ToArray(); if( _t is null ) { goto AddUpdate; } if(this.GetNoteCapacity() < _t.Length) { return false; } for(Int32 _ = 0; _ < _t.Length; _++) { _u.SetValue(_t[_],_+1); } }
            if(_4 is not null) { _u.SetValue(_4.GetID(),0); String[]? _t = _4.GetNotes()?.ToArray(); if( _t is null ) { goto AddUpdate; } if(this.GetNoteCapacity() < _t.Length) { return false; } for(Int32 _ = 0; _ < _t.Length; _++) { _u.SetValue(_t[_],_+1); } }
            if(_5 is not null) { _u.SetValue(_5.GetID(),0); String[]? _t = _5.GetNotes()?.ToArray(); if( _t is null ) { goto AddUpdate; } if(this.GetNoteCapacity() < _t.Length) { return false; } for(Int32 _ = 0; _ < _t.Length; _++) { _u.SetValue(_t[_],_+1); } }
            if(_6 is not null) { _u.SetValue(_6.GetID(),0); String[]? _t = _6.GetNotes()?.ToArray(); if( _t is null ) { goto AddUpdate; } if(this.GetNoteCapacity() < _t.Length) { return false; } for(Int32 _ = 0; _ < _t.Length; _++) { _u.SetValue(_t[_],_+1); } }
            if(_7 is not null) { _u.SetValue(_7.GetID(),0); String[]? _t = _7.GetNotes()?.ToArray(); if( _t is null ) { goto AddUpdate; } if(this.GetNoteCapacity() < _t.Length) { return false; } for(Int32 _ = 0; _ < _t.Length; _++) { _u.SetValue(_t[_],_+1); } }
    ...
    /**<include file='Notes.xml' path='Notes/class[@name="Notes"]/method[@name="AddUpdateDescriptor"]/*'/>*/
    internal Boolean AddUpdate(Descriptor? descriptor)
    {
        if(descriptor is null) { return false; }

        Descriptor _d = descriptor; Object[] _u = new Object[this.GetNoteCapacity()+1];

        try
        {
            _u.SetValue(_d.ID,0); String[]? _t = _d.Notes?.ToArray(); if( _t is null ) { goto AddUpdate; } if(this.GetNoteCapacity() < _t.Length) { return false; } for(Int32 _ = 0; _ < _t.Length; _++) { _u.SetValue(_t[_],_+1); }
    ...
    /**<include file='Notes.xml' path='Notes/class[@name="Notes"]/method[@name="Exists"]/*'/>*/
    ...
    /**<include file='Notes.xml' path='Notes/class[@name="Notes"]/method[@name="GetNoteCapacity"]/*'/>*/
    private Int32 GetNoteCapacity() { return this.Columns.Cast<DataColumn>().Count(_=>_.ColumnName.StartsWith("Note",StringComparison.Ordinal)); }

    /**<include file='Notes.xml' path='Notes/class[@name="Notes"]/method[@name="Remove"]/*'/>*/
    ...
    /**<include file='Notes.xml' path='Notes/class[@name="Notes"]/method[@name="RemoveDescriptor"]/*'/>*/
    ...
    /**<include file='Notes.xml' path='Notes/class[@name="Notes"]/method[@name="RemoveGuid"]/*'/>*/
