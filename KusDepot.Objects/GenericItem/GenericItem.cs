...
public sealed class GenericItem : DataItem , ICloneable , IComparable<GenericItem> , IEquatable<GenericItem> , IExtensibleDataObject , IParsable<GenericItem>
{
    ...
    /**<include file='GenericItem.xml' path='GenericItem/class[@name="GenericItem"]/field[@name="Sync"]/*'/>*/
    [DataMember(Name = "GenericItemSync" , EmitDefaultValue = true , IsRequired = true)]
    ...
    public GenericItem(IEnumerable<Object>? content = null , Guid? id = null , String? name = null , HashSet<String>? notes = null , HashSet<String>? tags = null , String? type = null)
    {
        try
        {
            this.Sync = new ItemSync();
    ...
    public override Object Clone()
    {
        try
        {
            GenericItem? _ = GenericItem.Parse(this.ToString(),null);
    ...
    public Boolean Equals(GenericItem? other)
    {
        try
        {
            ...
            List<Object>? _o = new List<Object>(); _o.AddRange(_i);
    ...
    public static GenericItem? FromFile(String path)
    {
        try
        {
            ...
            using(FileStream _0 = new FileStream(path,new FileStreamOptions(){Access = FileAccess.Read , Mode = FileMode.Open , Options = FileOptions.SequentialScan , Share = FileShare.Read}))
            {
                ...
                {
                    DataContractSerializer _2 = new DataContractSerializer(typeof(GenericItem),new DataContractSerializerSettings(){MaxItemsInObjectGraph = Int32.MaxValue});

                    return (GenericItem?)_2.ReadObject(_1);
                }
            }
        }
    ...
    public ImmutableList<Object>? GetContent()
    {
        try
        {
            if( this.Locked || this.Content is null ) { return null; }

            if(!TryEnter(this.Sync.Content,SyncTime)) { throw ContentSyncException; }

            return this.Content.ToImmutableList();
        }
        catch ( Exception ) { if(NoExceptions) { return null; } throw; }
    ...
    /**<include file='GenericItem.xml' path='GenericItem/class[@name="GenericItem"]/method[@name="GetDescriptor"]/*'/>*/
    public Descriptor? GetDescriptor()
    {
        try
        {
            return new Descriptor()
            {
                ...
                Name               = this.GetName(),
                Notes              = this.GetNotes(),
                ObjectType         = typeof(GenericItem).Name,
    ...
    public static GenericItem Parse(String input , IFormatProvider? format = null)
    {
        try
        {
            ...
            {
                DataContractSerializer _1 = new DataContractSerializer(typeof(GenericItem),new DataContractSerializerSettings(){MaxItemsInObjectGraph = Int32.MaxValue});

                GenericItem? _2 = (GenericItem?)_1.ReadObject(_0); if( _2 is not null ) { return _2; }

                throw new FormatException();
            }
        }
        catch ( Exception ) { if(NoExceptions) { return new GenericItem(); } throw; }
    }
    ...
    public Boolean SetContent(IEnumerable<Object>? content)
    {
        try
        {
            if( content is null || this.Locked ) { return false; } List<Object> _ = content.ToList();

            if(!TryEnter(this.Sync.Content,SyncTime)) { throw ContentSyncException; }

            if(Equals(_.Count,0)) { this.Content = null; return true; }

            this.Content = _; return true;
        }
        catch ( Exception ) { if(NoExceptions) { return false; } throw; }
    ...
    /**<include file='GenericItem.xml' path='GenericItem/class[@name="GenericItem"]/method[@name="ToFile"]/*'/>*/
    ...
    /**<include file='GenericItem.xml' path='GenericItem/class[@name="GenericItem"]/method[@name="ToString"]/*'/>*/
    ...
    /**<include file='GenericItem.xml' path='GenericItem/class[@name="GenericItem"]/method[@name="TryParse"]/*'/>*/
    public static Boolean TryParse([NotNullWhen(true)] String? input , IFormatProvider? format , [MaybeNullWhen(false)] out GenericItem item)
    {
        ...
        try
        {
            using(XmlDictionaryReader _0 = XmlDictionaryReader.CreateBinaryReader(input.ToByteArrayFromBase64(),XmlDictionaryReaderQuotas.Max))
            {
                ...
                GenericItem? _2 = (GenericItem?)_1.ReadObject(_0); if( _2 is not null ) { item = _2; return true; }
    ...
    /**<include file='GenericItem.xml' path='GenericItem/class[@name="GenericItem"]/method[@name="AcquireLocks"]/*'/>*/
    ...
    /**<include file='GenericItem.xml' path='GenericItem/class[@name="GenericItem"]/method[@name="ReleaseLocks"]/*'/>*/
