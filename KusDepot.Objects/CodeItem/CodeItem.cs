...
public sealed class CodeItem : DataItem , ICloneable , IComparable<CodeItem> , IEquatable<CodeItem> , IExtensibleDataObject , IParsable<CodeItem>
{
    ...
    /**<include file='CodeItem.xml' path='CodeItem/class[@name="CodeItem"]/field[@name="Sync"]/*'/>*/
    [DataMember(Name = "CodeItemSync" , EmitDefaultValue = true , IsRequired = true)]
    ...
    public CodeItem(String? content = null , Guid? id = null , String? name = null , HashSet<String>? notes = null , HashSet<String>? tags = null , String? type = null)
    {
        try
        {
            this.Sync = new ItemSync();
    ...
    public override Object Clone()
    {
        try
        {
            CodeItem? _ = CodeItem.Parse(this.ToString(),null);
    ...
    /**<include file='CodeItem.xml' path='CodeItem/class[@name="CodeItem"]/method[@name="IComparable{CodeItem}.CompareTo"]/*'/>*/
    ...
    /**<include file='CodeItem.xml' path='CodeItem/class[@name="CodeItem"]/method[@name="EqualsObject"]/*'/>*/
    public override Boolean Equals(Object? other) { return this.Equals(other as CodeItem); }

    /**<include file='CodeItem.xml' path='CodeItem/class[@name="CodeItem"]/method[@name="IEquatable{CodeItem}.Equals"]/*'/>*/
    ...
    public static CodeItem? FromFile(String path)
    {
        try
        {
            ...
            using(FileStream _0 = new FileStream(path,new FileStreamOptions(){Access = FileAccess.Read , Mode = FileMode.Open , Options = FileOptions.SequentialScan , Share = FileShare.Read}))
            {
                ...
                {
                    DataContractSerializer _2 = new DataContractSerializer(typeof(CodeItem),new DataContractSerializerSettings(){MaxItemsInObjectGraph = Int32.MaxValue});

                    return (CodeItem?)_2.ReadObject(_1);
                }
            }
        }
    ...
    /**<include file='CodeItem.xml' path='CodeItem/class[@name="CodeItem"]/method[@name="GetDescriptor"]/*'/>*/
    public Descriptor? GetDescriptor()
    {
        try
        {
            return new Descriptor()
            {
                ...
                Name               = this.GetName(),
                Notes              = this.GetNotes(),
                ObjectType         = typeof(CodeItem).Name,
    ...
    /**<include file='CodeItem.xml' path='CodeItem/class[@name="CodeItem"]/method[@name="GetHashCode"]/*'/>*/
    ...
    public static CodeItem Parse(String input , IFormatProvider? format = null)
    {
        try
        {
            ...
            {
                DataContractSerializer _1 = new DataContractSerializer(typeof(CodeItem),new DataContractSerializerSettings(){MaxItemsInObjectGraph = Int32.MaxValue});

                CodeItem? _2 = (CodeItem?)_1.ReadObject(_0); if( _2 is not null ) { return _2; }

                throw new FormatException();
            }
        }
        catch ( Exception ) { if(NoExceptions) { return new CodeItem(); } throw; }
    }
    ...
    /**<include file='CodeItem.xml' path='CodeItem/class[@name="CodeItem"]/method[@name="ToFile"]/*'/>*/
    ...
    /**<include file='CodeItem.xml' path='CodeItem/class[@name="CodeItem"]/method[@name="ToString"]/*'/>*/
    ...
    /**<include file='CodeItem.xml' path='CodeItem/class[@name="CodeItem"]/method[@name="TryParse"]/*'/>*/
    public static Boolean TryParse([NotNullWhen(true)] String? input , IFormatProvider? format , [MaybeNullWhen(false)] out CodeItem item)
    {
        ...
        try
        {
            using(XmlDictionaryReader _0 = XmlDictionaryReader.CreateBinaryReader(input.ToByteArrayFromBase64(),XmlDictionaryReaderQuotas.Max))
            {
                ...
                CodeItem? _2 = (CodeItem?)_1.ReadObject(_0); if( _2 is not null ) { item = _2; return true; }
    ...
    /**<include file='CodeItem.xml' path='CodeItem/class[@name="CodeItem"]/method[@name="Validate"]/*'/>*/
    public static Boolean Validate(CodeItem? item)
    {
        if(item is null) { return false; }

        try { return new CodeItemValidator().Validate(item).IsValid; }

        catch ( Exception ) { if(NoExceptions) { return false; } throw; }
    }

    /**<include file='CodeItem.xml' path='CodeItem/class[@name="CodeItem"]/method[@name="AcquireLocks"]/*'/>*/
    ...
    /**<include file='CodeItem.xml' path='CodeItem/class[@name="CodeItem"]/method[@name="ReleaseLocks"]/*'/>*/
...
/**<include file='CodeItem.xml' path='CodeItem/class[@name="CodeItemValidator"]/*'/>*/
public class CodeItemValidator : AbstractValidator<CodeItem>
{
    /**<include file='CodeItem.xml' path='CodeItem/class[@name="CodeItemValidator"]/constructor[@name="Constructor"]/*'/>*/
    public CodeItemValidator()
    {
        this.RuleFor( (item) => item.GetContent()).NotNull().NotEmpty();
        this.RuleFor( (item) => item.GetType()).NotNull().NotEmpty().Must( (item,String) => { return CodeItemValidDataTypes.Contains(item.GetType()); } );
    }
}