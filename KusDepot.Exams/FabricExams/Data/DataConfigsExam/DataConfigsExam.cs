...
{
    public IDataConfigs? DataConfigs;
    ...
    public void Calibrate()
    {
        ...
        this.ActorId = new("DataConfigsExam"); this.DataConfigs = ActorProxy.Create<IDataConfigs>(ActorId,ServiceLocators.DataConfigsService);
