...
public class DataControlExam
{
    ...
    {
        Byte[] a = new Byte[1363480]; RandomNumberGenerator.Create().GetBytes(a); BinaryItem b = new();
        ...
        Check.That(await b.SetContentStreamed(true)).IsTrue(); ManagementKey? k = b.CreateManagementKey("Test"); Check.That(await b.EncryptData(k)).IsTrue(); this.BinaryStream = b;
    ...
    public async Task GetStream()
    {
        ...
        DownloadInfo? di = await _dc.GetStream(id,fp,ip,this.ReadToken); Check.That(di).IsNotNull();
