...
public class CatalogExamData
{
    public static IEnumerable<Descriptor> Build()
    {
        ...
        var d01 = new BinaryItem(type: DataTypes.CER);                       list.Add(d01.GetDescriptor()!);
        var d02 = new CodeItem(name: "Deploy-OS" , type: DataTypes.PS1);     list.Add(d02.GetDescriptor()!);
        var d03 = new GenericItem(type: DataTypes.JSON);                     list.Add(d03.GetDescriptor()!);
        ...
        var d06 = new MultiMediaItem(type: DataTypes.PNG);                   list.Add(d06.GetDescriptor()!);
        var d07 = new TextItem(name: "Config1" , type: DataTypes.XML);       list.Add(d07.GetDescriptor()!);
        var d08 = new TextItem(name: "Config2" , type: DataTypes.XML);       list.Add(d08.GetDescriptor()!);
        ...
        var d18 = new GuidReferenceItem(tags: new HashSet<String>(){"Tag300","Tag500","Tag600"}); d18.SetObjectFILE("G18"); list.Add(d18.GetDescriptor()!);
        ...
        var d20 = new BinaryItem(); d20.SetFILE(Assembly.GetExecutingAssembly().Location);
        d20.SetContentStreamed(true).GetAwaiter().GetResult();
