...
internal static class Space
{
    ...
    internal static void Main()
    {
        ...
        var r = BinaryItem.FromFile(Path.Combine(AppContext.BaseDirectory,"kusdepot_reactr.bin"));

        File.WriteAllBytes(Path.Combine(AppContext.BaseDirectory,"kusdepot_reactr.dll"),r!.GetContent()!);
