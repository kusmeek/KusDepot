...
namespace KusDepot.ToolServiceHostExam;

[TestFixture] [SingleThreaded] [Parallelizable(ParallelScope.All)]
public class ToolServiceHostExam
{
    ...
    private static String URL = "https://localhost:4434/ToolService";
    ...
    {
        var r = new StandardRequest(); r.Data = "ToolServiceHostExam";
