...
internal static class ToolActorStrings
{
    public const String LogDirectory       = @"C:\KusDepotLogs\ToolActor\";

    public const String ExecutingCommand   = @"[{@ActorID}] Executing Handle [{@Handle}] ID [{@ID}]";
    public const String ExecuteCommandFail = @"ExecuteCommand Failed [{@ActorID}] Handle [{@Handle}] ID [{@ID}] ";
    ...
    public const String RegisterSuccess    = @"Registration Succeeded [{@PID}]";
    ...
    public const String ToolActorFail      = @"ToolActor Service Failed [{@ActorID}]";
}