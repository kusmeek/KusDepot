...
public class CodeItemSecurityExam
{
    ...
    {
        var content = "public class WipeData_InMemory_NotEncrypted { }";
        var item = new CodeItem(content);
        var key = item.CreateManagementKey("TestKey");
        Assert.That(await item.SignData("Content", key), Is.Not.Null);
    ...
    {
        var content = "public class WipeData_InMemory_Encrypted { }";
        var item = new CodeItem(content);
        var key = item.CreateManagementKey("TestKey");
        Assert.That(await item.EncryptData(key, true), Is.True);
    ...
    {
        var content = "public class WipeData_Locked_InvalidKey { }";
        var item = new CodeItem(content);
    ...
    {
        var content = "public class WipeData_Locked_ValidKey { }";
        var item = new CodeItem(content);
        var key = item.CreateManagementKey("TestKey");
