...
public class GenericItemSecurityExam
{
    ...
    {
        var nestedText = new String("nested text".ToCharArray());
        var textItem = new TextItem(nestedText);
        var byteArray = new Byte[] { 1, 2, 3, 4 };
        var string1 = new String(Enumerable.Range(0, 4).Select(i => (Char)('a' + i)).ToArray());
