...
public partial class GenericItemExam
{
    ...
    {
        GenericItem _0 = new GenericItem(content:new List<Object>(),id:Guid.NewGuid(),name:String.Empty,notes:new HashSet<String>(),tags:new HashSet<String>(),type:DataTypes.SGML);
    ...
    {
        Byte[] _0 = new Byte[16]; RandomNumberGenerator.Create().GetBytes(_0);
        Object _3 = new();

        GenericItem? _1 = (GenericItem?)new Object[]{_0,_3};
        GenericItem? _2 = (GenericItem?)null;

        Check.That(_1).IsNotNull();
        Check.That(_1!.GetContent()!.Count).IsEqualTo(2);
        ...
        Check.That(_4!.Length).IsEqualTo(2);
        Check.That(_5).IsNull();
    }
    ...
    [Test]
    public void GetContent_CachesSnapshotUntilMutation()
    {
        GenericItem _0 = new(new Object[]{"Alpha",123});

        var _1 = _0.GetContent();
        var _2 = _0.GetContent();

        Check.That(_1).IsNotNull();
        Check.That(ReferenceEquals(_1,_2)).IsTrue();
    }

    [Test]
    public void GetContent_InvalidatesSnapshotOnSetContent()
    {
        GenericItem _0 = new(new Object[]{"Alpha",123});

        var _1 = _0.GetContent();

        Check.That(_0.SetContent(new Object[]{"Beta",456})).IsTrue();

        var _2 = _0.GetContent();

        Check.That(_2).IsNotNull();
        Check.That(ReferenceEquals(_1,_2)).IsFalse();
        Check.That(_2!).ContainsExactly("Beta",456);
    }
    ...
    public void GetDescriptor()
    {
        ...
        Check.That(_0.SetDataType(DataTypes.DIT)).IsTrue();
        ...
        Check.That(_.DataType).Equals(DataTypes.DIT);
    ...
    public void GetHash()
    {
        ...
        Check.That(_2.GetHashCode()).IsEqualTo(_3.GetHashCode());
        Check.That(_4.GetHashCode()).IsEqualTo(_5.GetHashCode());
    }
    ...
    public void IsMetadataOnly()
    {
        ...
        Check.That(_0.SetContent(new Object[]{"Alpha",123})).IsTrue();
    ...
    public void Serialize()
    {
        ...
        var _3 = new GenericItem(content:new List<Object>(){_1,_2},id:null,name:String.Empty);

        Byte[] _4 = _3.Serialize();

        GenericItem? _5 = DataItem.Deserialize<GenericItem>(_4);

        Check.That(_4.Length).IsStrictlyGreaterThan(0);
        Check.That(_5).IsNotNull();
        Check.That(((GenericItem)_3).Equals(_5)).IsTrue();
    }
    ...
    public async Task GetHashCodeAsync()
    {
        ...
        Check.That(item.SetContent(first)).IsTrue();
        ...
        List<Object> second = new()
        {
            ...
            DataItemGenerator.CreateDataSet(4)
        };

        Check.That(item.SetContent(second)).IsTrue();
        ...
        List<Object> third = new(second)
        {
            "gamma"
        };

        Check.That(item.SetContent(third)).IsTrue();
