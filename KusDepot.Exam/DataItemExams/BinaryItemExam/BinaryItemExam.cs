...
public partial class BinaryItemExam
{
    ...
    public void ExplicitOperator()
    {
        ...
        BinaryItem? _1 = (BinaryItem?)_0;
        BinaryItem? _2 = (BinaryItem?)null;
        ...
        Check.That(_3!.SequenceEqual(_0)).IsTrue();
    ...
    public async Task GetContent()
    {
        ...
        var dc1 = await _3.GetDataContent(security:null);
    ...
    public void GetDataType()
    {
        ...
        Check.That(_0.SetDataType(DataTypes.ACCDB)).IsTrue();
        Check.That(_0.RegisterManager(KeyM)).IsTrue();
        Check.That(_0.Lock(KeyM)).IsTrue();
        Check.That(_0.GetDataType()).Equals(DataTypes.ACCDB);
    }
    ...
    public void GetDescriptor()
    {
        ...
        Check.That(_0.SetDataType(DataTypes.DLL)).IsTrue();
        ...
        Check.That(_.DataType).Equals(DataTypes.DLL);
    ...
    public void IsMetadataOnly()
    {
        ...
        Check.That(_0.SetContent([1])).IsTrue();
    ...
    public void SetDataType()
    {
        ...
        Check.That(_0.Lock(KeyM)).IsTrue();
        Check.That(_0.GetDataType()).Equals(DataTypes.ACCDB);
        Check.That(_0.SetDataType(DataTypes.ISO)).IsFalse();
    }
    ...
    public void Serialize()
    {
        ...
        var _0 = new BinaryItem(content:_1,id:null,name:String.Empty);

        Byte[] _2 = _0.Serialize();

        BinaryItem? _3 = DataItem.Deserialize<BinaryItem>(_2);

        Check.That(_2.Length).IsStrictlyGreaterThan(0);
        Check.That(_3).IsNotNull();
        Check.That(((BinaryItem)_0).Equals(_3)).IsTrue();
    }
    ...
    public async Task GetHashCodeAsync()
    {
        ...
        BinaryItem item = new BinaryItem(data);
        ...
        rng.GetBytes(data);
        Check.That(item.SetContent(data)).IsTrue();
