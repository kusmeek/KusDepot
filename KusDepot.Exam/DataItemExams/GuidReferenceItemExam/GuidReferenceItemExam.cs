...
public partial class GuidReferenceItemExam
{
    ...
    public async Task GetDataContent()
    {
        ...
        var dc1 = await item.GetDataContent(security:null);
        Check.That(dc1).IsNotNull();
        Check.That(dc1!.GuidReference).IsNotNull();
    ...
    public void GetDataType()
    {
        ...
        Check.That(_0.GetDataType()).Equals(DataTypes.GUID);
    }
    ...
    public void GetDescriptor()
    {
        ...
        Check.That(_.DataType).Equals(DataTypes.GUID);
    ...
    public async Task SetContentStreamed()
    {
        ...
        Check.That(await _0.SetContentStreamed(true,(DataItemSecurityContext?)null)).IsFalse();
    ...
    public void SetDataType()
    {
        ...
        Check.That(_0.SetDataType(DataTypes.EVTX)).IsFalse();
        Check.That(_0.GetDataType()).Equals(DataTypes.GUID);
    }
    ...
    public void SetNext()
    {
        ...
        Check.That(_0.RegisterManager(KeyM)).IsTrue();
        Check.That(_0.Lock(KeyM)).IsTrue();
        Check.That(_0.SetNext(_1)).IsFalse();
    }
    ...
    {
        var _0 = new GuidReferenceItem(content:Guid.NewGuid(),id:Guid.NewGuid());

        Byte[] _1 = _0.Serialize();

        GuidReferenceItem? _2 = DataItem.Deserialize<GuidReferenceItem>(_1);

        Check.That(_1.Length).IsStrictlyGreaterThan(0);
        Check.That(_2).IsNotNull();
        Check.That(((GuidReferenceItem)_0).Equals(_2)).IsTrue();
    }
    ...
    {
        GuidReferenceItem item = new GuidReferenceItem(Guid.NewGuid());
        ...
        GuidReferenceItem next = new GuidReferenceItem(Guid.NewGuid());
        GuidReferenceItem previous = new GuidReferenceItem(Guid.NewGuid());
        HashSet<GuidReferenceItem> undirected = new()
        {
            new(Guid.NewGuid()),
            new(Guid.NewGuid())
        };
        ...
        Check.That(item.SetContent(newContent)).IsTrue();
