...
public class MultiMediaItemSecurityExam
{
    ...
    public async Task MaskData_InMemory_NotEncrypted()
    {
        ...
        Assert.That((await item.GetDataContent())!.MultiMedia!["Content"], Is.EqualTo(content));
        ...
        Assert.That(((await item.GetDataContent(key))!.MultiMedia!["Content"] as Byte[]), Is.EqualTo(content));
