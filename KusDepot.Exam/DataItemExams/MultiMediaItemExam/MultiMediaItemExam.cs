...
public partial class MultiMediaItemExam
{
    ...
    public void ExplicitOperator()
    {
        ...
        MultiMediaItem? _1 = (MultiMediaItem?)_0;
        MultiMediaItem? _2 = (MultiMediaItem?)null;
    ...
    public void SetLanguage()
    {
        ...
        Check.That(_0.RegisterManager(KeyM)).IsTrue();
        Check.That(_0.Lock(KeyM)).IsTrue();
        Check.That(_0.SetLanguage(DataTags.Language.nya)).IsFalse();
    }
    ...
    public void Serialize()
    {
        ...
        var _0 = new MultiMediaItem(content:_1,id:null,name:String.Empty);

        Byte[] _2 = _0.Serialize();

        MultiMediaItem? _3 = DataItem.Deserialize<MultiMediaItem>(_2);

        Check.That(_2.Length).IsStrictlyGreaterThan(0);
        Check.That(_3).IsNotNull();
        Check.That(((MultiMediaItem)_0).Equals(_3)).IsTrue();
    }
    ...
    public async Task GetHashCodeAsync()
    {
        ...
        MultiMediaItem item = new MultiMediaItem(data);
