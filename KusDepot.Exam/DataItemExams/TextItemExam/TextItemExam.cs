...
public partial class TextItemExam
{
    ...
    public void ExplicitOperator()
    {
        ...
        TextItem? _1 = (TextItem?)_0;
        TextItem? _2 = (TextItem?)null;
    ...
    public void GetDescriptor()
    {
        ...
        Check.That(_.DataType).Equals(DataTypes.NFO);
    ...
    public void GetLanguage()
    {
        ...
        Check.That(_0.SetLanguage(DataTags.Language.swa)).IsTrue();
        Check.That(_0.GetLanguage()).IsEqualTo(DataTags.Language.swa);
    }
    ...
    public void SetDataType()
    {
        ...
        Check.That(_0.Lock(KeyM)).IsTrue();
        Check.That(_0.GetDataType()).Equals(DataTypes.NFO);
        Check.That(_0.SetDataType(DataTypes.TXT)).IsFalse();
    }
    ...
    {
        var _0 = new TextItem(TestCaseDataGenerator.GenerateUnicodeString(8192));

        Byte[] _1 = _0.Serialize();

        TextItem? _2 = DataItem.Deserialize<TextItem>(_1);

        Check.That(_1.Length).IsStrictlyGreaterThan(0);
        Check.That(_2).IsNotNull();
        Check.That(((TextItem)_0).Equals(_2)).IsTrue();
    }
    ...
    public async Task GetHashCodeAsync()
    {
        ...
        text = TestCaseDataGenerator.GenerateUnicodeString(1024);
