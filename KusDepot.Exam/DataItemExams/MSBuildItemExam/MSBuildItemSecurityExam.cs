...
public class MSBuildItemSecurityExam
{
    ...
    public async Task MaskData_InMemory_NotEncrypted()
    {
        ...
        Assert.That(dataContent!.MSBuild, Is.Not.Null);
        Assert.That(dataContent.MSBuild!.ContainsKey("Content"), Is.True);
        Assert.That(dataContent.MSBuild["Content"], Is.EqualTo(content));
        ...
        Assert.That(unmasked!.MSBuild, Is.Not.Null);
        Assert.That(unmasked.MSBuild!.ContainsKey("Content"), Is.True);
        Assert.That(unmasked.MSBuild["Content"], Is.EqualTo(content));
        ...
        Assert.That(dataContent2!.MSBuild, Is.Not.Null);
        Assert.That(dataContent2.MSBuild!.ContainsKey("Content"), Is.True);
        Assert.That(dataContent2.MSBuild["Content"], Is.EqualTo(content));
    }
    ...
    public async Task MaskData_InMemory_Encrypted()
    {
        ...
        Assert.That(unmasked2!.MSBuild, Is.Not.Null);
        Assert.That(unmasked2.MSBuild!.ContainsKey("Content"), Is.True);
        Assert.That(unmasked2.MSBuild["Content"], Is.EqualTo(content));
    }
