...
public partial class MSBuildItemExam
{
    ...
    public void EqualsInterface()
    {
        ...
        Check.That(_3.GetHashCode()).IsEqualTo(_5.GetHashCode());
    ...
    public async Task GetDataContent()
    {
        ...
        Check.That(await _i.EncryptData(DataItemSecurityContextExamHelpers.CreateContext(_i,KeyM!))).IsTrue();
        Check.That(await _i.GetDataContent(security:null)).IsNull();
    ...
    public void GetDataType()
    {
        ...
        Check.That(_0.SetDataType(DataTypes.SFPROJ)).IsFalse();
    }
    ...
    public void GetDescriptor()
    {
        ...
        Check.That(_.DataType).Equals(DataTypes.MSB);
    ...
    public void GetHash()
    {
        ...
        Check.That(_0.GetHashCode()).IsEqualTo(_6.GetHashCode());
    }
    ...
    public void IsMetadataOnly()
    {
        ...
        Check.That(_0.SetContent("Alpha")).IsTrue();
    ...
    public void ParameterlessConstructor()
    {
        ...
        Check.That(_0.GetDataType()).Equals(DataTypes.MSB);
    ...
    public void SetDataType()
    {
        ...
        Check.That(_0.GetDataType()).Equals(DataTypes.MSB);
        Check.That(_0.SetDataType(DataTypes.MSB)).IsFalse();
    }
    ...
    {
        var _0 = new MSBuildItem(TestCaseDataGenerator.GenerateUnicodeString(8192));

        Byte[] _1 = _0.Serialize();

        MSBuildItem? _2 = DataItem.Deserialize<MSBuildItem>(_1);

        Check.That(_1.Length).IsStrictlyGreaterThan(0);
        Check.That(_2).IsNotNull();
        Check.That(((MSBuildItem)_0).Equals(_2)).IsTrue();
    }
    ...
    {
        String content = TestCaseDataGenerator.GenerateUnicodeString(2048);
        MSBuildItem item = new MSBuildItem(content);
        ...
        content = TestCaseDataGenerator.GenerateUnicodeString(1024);
        ...
        var requirements = new HashSet<DataItem>() { new TextItem("Requirement A") };
        Check.That(item.SetRequirements(requirements)).IsTrue();

        var sequence = new SortedList<Int32, MSBuildItem>() { { 0, new MSBuildItem("Step 1") }, { 1, new MSBuildItem("Step 2") } };
        Check.That(item.SetSequence(sequence)).IsTrue();
