...
public class AccessManagerExam
{
    ...
    public void GenerateAccessKey_Generic_Generates_ClientKey()
    {
        ...
        var key = manager.GenerateAccessKey<ClientKey>(Guid.NewGuid().ToString(), ImmutableArray.Create(ProtectedOperation.GetOutputIDs));
    ...
    public void GenerateAccessKey_Generic_NullPermissions_Uses_Empty_Set()
    {
        ...
        var key = manager.GenerateAccessKey<ClientKey>(Guid.NewGuid().ToString(), null);
    ...
    public void GenerateAccessKey_Generic_Uses_AccessCheck_When_Locked()
    {
        ...
        var denied = manager!.GenerateAccessKey<ClientKey>(Guid.NewGuid().ToString(), ImmutableArray<Int32>.Empty, null);
        var allowed = manager.GenerateAccessKey<ClientKey>(Guid.NewGuid().ToString(), ImmutableArray<Int32>.Empty, executiveKey);
