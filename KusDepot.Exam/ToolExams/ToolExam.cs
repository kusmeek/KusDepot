...
public partial class ToolExam
{
    ...
    public void Constructor()
    {
        ...
        Tool _99 = new Tool(data:_0,id:_15,inputs:_22);
    ...
    [Test]
    public void GetContainerScope()
    {
        IToolBuilder tb = ToolBuilderFactory.CreateBuilder();

        tb.ConfigureContainer((_,cb) => { cb.RegisterType<Tool001>().AsImplementedInterfaces(); });

        Tool000 _ = tb.Build<Tool000>();

        Check.That(_.GetContainerScope()!.GetType().IsAssignableTo<ILifetimeScope>()).IsTrue();
    }
    ...
    {
        var _ = new ContainerBuilder();

        _.RegisterType<CommandTestR>().AsImplementedInterfaces().WithMetadata("Handle","Work1");
        _.RegisterType<CommandTestR>().As<ICommand>().WithMetadata("Handle","Work2");
        _.RegisterType<CommandTestR>().As<ICommand>().WithMetadata("Handle","Work3");
        _.RegisterType<CommandTestR>().As<ICommand>().WithMetadata("Handle","WorkN");
        _.RegisterType<CommandTest>().As<Object>();
        _.RegisterType<CommandTest>().As<Object>();
        _.RegisterType<CommandTest>().As<Object>();
        _.RegisterType<CommandTest>().As<Object>();
        _.RegisterType<CommandTest>().As<Object>();
        ...
        _.RegisterType<Tool>().AsImplementedInterfaces();

        var __ = _.Build().BeginLifetimeScope().ResolveOptional<ITool>();

        Check.That(__!.MaskCommandTypes(false)).IsTrue();

        Check.That(__.GetCommandTypes()!.Count).Equals(4);

        Check.That(__.GetInputs()!.Count).Equals(6);
    }
    ...
    public void Injection2()
    {
        ...
        var __ = new Tool(container:_.Build());
    ...
    public void ParameterlessConstructor()
    {
        ...
        Check.That(_0.GetCommandTypes()).IsNull();
        Check.That(_0.GetContainerScope()).IsNull();
