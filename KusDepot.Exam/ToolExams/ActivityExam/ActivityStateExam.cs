...
public class ActivityStateExam
{
    ...
    public async Task Canceled()
    {
        ...
        Check.ThatAsyncCode(async () => id = await tool.ExecuteCommandAsync(details,cts.Token)).DoesNotThrow();
    ...
    public async Task CanceledRunning()
    {
        ...
        Guid? r = null; Check.ThatAsyncCode(async () => r = await tool.ExecuteCommandAsync(details,cts.Token)).DoesNotThrow();
    ...
    public async Task TimedOut()
    {
        ...
        Check.ThatAsyncCode(async () => id = await tool.ExecuteCommandAsync(details)).DoesNotThrow();
    ...
    public async Task TimedOutRunning()
    {
        ...
        CommandDetails details = CommandDetails.Create("TimedOutAsyncState").SetID(id).SetTimeout(TimeSpan.FromSeconds(1));

        Guid? r = null; Check.ThatAsyncCode(async () => r = await tool.ExecuteCommandAsync(details)).DoesNotThrow();
    ...
    public async Task Failed()
    {
        ...
        Check.ThatAsyncCode(async () => r = await tool.ExecuteCommandAsync(details)).DoesNotThrow();
