...
public class ToolHost1 : Tool
{
    ...
    public ToolHost1(IAccessManager? accessmanager = null,
                ...
                Guid? id = null,
                IEnumerable<Meta<ICommand>>? commands = null,
                IConfiguration? configuration = null,
                IContainer? container = null,
                IEnumerable<Object>? inputs = null,
                ILogger? logger = null)
        : base(accessmanager:accessmanager,data:data,id:id,commands:commands,configuration:configuration,container:container,inputs:inputs,logger:logger) { this.EnableMyExceptions(); }
