...
public class CommandWorkflowExam
{
    ...
    public void Constructor()
    {
        ...
        var wf = new CommandWorkflow(details , "WF-A");

        Check.That(wf.Details).IsSameReferenceAs(details);
        Check.That(wf.Name).IsEqualTo("WF-A");
    ...
    public void LogEvent_Format()
    {
        ...
        var wf = new CommandWorkflow(details , "WF-LOG");
    ...
    public void Json()
    {
        ...
        var wf = new CommandWorkflow(details , "WF-J");
        ...
        Check.That(wf2.Name).IsEqualTo("WF-J");
    ...
    public void FileLogger_ParseLine()
    {
        ...
        var wf = new CommandWorkflow(details , "WF-FILE");
