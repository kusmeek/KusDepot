...
public class MediaLibraryExam
{
    ...
    public void AddUpdate()
    {
        ...
        MultiMediaItem _9 = new MultiMediaItem();
        ...
        Check.That(_0.AddUpdate(_9.ToString())).IsTrue();
        ...
        Check.That(_0.Tables[Ark.MediaLibraryTableName]!.Rows.Count).IsEqualTo(2);
    }
    ...
    public void AddUpdateDescriptor()
    {
        ...
        Check.That(_0.AddUpdate(_9.GetDescriptor())).IsTrue();
    ...
    public void Remove()
    {
        ...
        Check.That(_0.Tables[Ark.MediaLibraryTableName]!.Rows.Count).IsEqualTo(1);

        Check.That(_0.Remove(_9.ToString())).IsTrue();

        Check.That(_0.Tables[Ark.MediaLibraryTableName]!.Rows.Count).IsEqualTo(0);
    }
    ...
    public void RemoveDescriptor()
    {
        ...
        Check.That(_0.Remove(_9.GetDescriptor())).IsTrue();
