...
public class ToolGenericHostingExam
{
    ...
    public async Task ToolGenericHosting()
    {
        ...
        Check.That(_.GetLifeCycleState()).IsEqualTo(LifeCycleState.Initialized);
    ...
    public async Task ToolGenericHostSelfHost()
    {
        ...
        Check.That(h.GetLifeCycleState()).IsEqualTo(LifeCycleState.Initialized);

        Check.That(x.GetLifeCycleState()).IsEqualTo(LifeCycleState.Initialized);

        Check.That(n.GetLifeCycleState()).IsEqualTo(LifeCycleState.Initialized);
    ...
    public async Task ToolGenericHostToolHost()
    {
        ...
        Check.That(m.GetLifeCycleState()).IsEqualTo(LifeCycleState.Initialized);
    ...
    public async Task ToolGenericHostWebHost()
    {
        ...
        Check.That(w.GetLifeCycleState()).IsEqualTo(LifeCycleState.Initialized);
