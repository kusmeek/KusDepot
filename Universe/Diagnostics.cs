...
internal partial class Universe
{
    ...
    {
        Trace = new ActivitySource("KusDepot.Data.Universe","0.0.1");

        Tracer = Sdk.CreateTracerProviderBuilder().ConfigureResource(_=>{_.Clear();}).AddSource("KusDepot.Data.Universe").AddOtlpExporter().AddConsoleExporter().Build();
    }
