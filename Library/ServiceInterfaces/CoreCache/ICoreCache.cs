...
{
    /**<include file='ICoreCache.xml' path='ICoreCache/interface[@name="ICoreCache"]/method[@name="CleanUp"]/*'/>*/
    public Task<Boolean> CleanUp(TimeSpan? age , String? traceid , String? spanid);
