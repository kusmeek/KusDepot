...
{
    /**<include file='ServiceLocators.xml' path='ServiceLocators/class[@name="ServiceLocators"]/property[@name="ArkKeeperService"]/*'/>*/
    public static Uri ArkKeeperService
    {
        get
        {
            return new Uri("fabric:/KusDepot.Data/ArkKeeperActorService");
        }
    }
    ...
    /**<include file='ServiceLocators.xml' path='ServiceLocators/class[@name="ServiceLocators"]/property[@name="UniverseService"]/*'/>*/
    public static Uri UniverseService
    {
        get
        {
            return new Uri("fabric:/KusDepot.Data/UniverseActorService");
        }
    }
