...
For integration see ToolConnect, DependencyInjection, KusDepotRegistry, ToolData, and KusDepotCab.


Storage items include TextItem, CodeItem, BinaryItem, MultiMediaItem, MSBuildItem, GenericItem, KeySet, DataSetItem, and DataStreamItem.
...
See DaprSidecar, ToolWorkflow, and ToolPod.

DataControl and Catalog APIs manage item storage and searching using Orleans Actors.
...
<br>
<div align="center">
  <h2>Orleans Actor Services</h2>
  <a href="https://raw.githubusercontent.com/kusmeek/KusDepot/main/KusDepot.Docs/Diagrams/ServiceInterfaces.png" target="_blank">
     <img src="https://raw.githubusercontent.com/kusmeek/KusDepot/main/KusDepot.Docs/Diagrams/ServiceInterfaces.png" alt="Orleans Actor Services" style="max-width:100%; height:auto;" />
  </a>
</div>
<br>
...
Copyright © 2026 KusDepot Solutions LLC <mike@kusdepotsolutions.net>
