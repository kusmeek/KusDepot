...
public interface IToolBuilder
{
    ...
    /**<include file='IToolBuilder.xml' path='IToolBuilder/interface[@name="IToolBuilder"]/method[@name="BuildGenericFactory"]/*'/>*/
    TTool Build<TTool>(ToolFactory<TTool> factory) where TTool : notnull , ITool , new();
    ...
    /**<include file='IToolBuilder.xml' path='IToolBuilder/interface[@name="IToolBuilder"]/method[@name="BuildAsyncGenericFactory"]/*'/>*/
    Task<TTool> BuildAsync<TTool>(ToolFactory<TTool> factory , CancellationToken cancel = default) where TTool : notnull , ITool , new();
