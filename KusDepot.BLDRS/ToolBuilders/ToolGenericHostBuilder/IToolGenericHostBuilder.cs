...
public interface IToolGenericHostBuilder : IToolBuilder
{
    ...
    /**<include file='IToolGenericHostBuilder.xml' path='IToolGenericHostBuilder/interface[@name="IToolGenericHostBuilder"]/method[@name="BuildGenericHostOpenFactory"]/*'/>*/
    IToolGenericHost BuildGenericHost<TToolGenericHost>(ToolGenericHostFactory<TToolGenericHost> factory , IHost? host = null) where TToolGenericHost : notnull , IToolGenericHost , new();
    ...
    /**<include file='IToolGenericHostBuilder.xml' path='IToolGenericHostBuilder/interface[@name="IToolGenericHostBuilder"]/method[@name="BuildGenericHostAsyncOpenFactory"]/*'/>*/
    Task<IToolGenericHost> BuildGenericHostAsync<TToolGenericHost>(ToolGenericHostFactory<TToolGenericHost> factory , IHost? host = null , CancellationToken cancel = default) where TToolGenericHost : notnull , IToolGenericHost , new();
