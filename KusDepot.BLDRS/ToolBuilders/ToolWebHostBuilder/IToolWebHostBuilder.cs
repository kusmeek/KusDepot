...
public interface IToolWebHostBuilder : IToolBuilder
{
    ...
    /**<include file='IToolWebHostBuilder.xml' path='IToolWebHostBuilder/interface[@name="IToolWebHostBuilder"]/method[@name="BuildWebHostOpenFactory"]/*'/>*/
    IToolWebHost BuildWebHost<TToolWebHost>(ToolWebHostFactory<TToolWebHost> factory , WebApplication? app = null) where TToolWebHost : notnull , IToolWebHost , new();
    ...
    /**<include file='IToolWebHostBuilder.xml' path='IToolWebHostBuilder/interface[@name="IToolWebHostBuilder"]/method[@name="BuildWebHostAsyncOpenFactory"]/*'/>*/
    Task<IToolWebHost> BuildWebHostAsync<TToolWebHost>(ToolWebHostFactory<TToolWebHost> factory , WebApplication? app = null , CancellationToken cancel = default) where TToolWebHost : notnull , IToolWebHost , new();
