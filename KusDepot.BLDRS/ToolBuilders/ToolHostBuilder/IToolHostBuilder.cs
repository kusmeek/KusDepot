...
public interface IToolHostBuilder : IToolBuilder
{
    ...
    /**<include file='IToolHostBuilder.xml' path='IToolHostBuilder/interface[@name="IToolHostBuilder"]/method[@name="BuildHostOpenFactory"]/*'/>*/
    IToolHost BuildHost<TToolHost>(ToolHostFactory<TToolHost> factory) where TToolHost : notnull , IToolHost , new();
    ...
    /**<include file='IToolHostBuilder.xml' path='IToolHostBuilder/interface[@name="IToolHostBuilder"]/method[@name="BuildHostAsyncOpenFactory"]/*'/>*/
    Task<IToolHost> BuildHostAsync<TToolHost>(ToolHostFactory<TToolHost> factory , CancellationToken cancel = default) where TToolHost : notnull , IToolHost , new();
