...
internal sealed class GetTransferStateTransformer : IOpenApiOperationTransformer
{
    ...
    {
        if(String.Equals(operation.OperationId,"GetTransferState",OrdinalIgnoreCase))
        {
