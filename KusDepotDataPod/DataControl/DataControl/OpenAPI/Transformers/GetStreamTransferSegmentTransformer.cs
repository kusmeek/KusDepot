...
internal sealed class GetStreamTransferSegmentTransformer : IOpenApiOperationTransformer
{
    ...
    {
        if(String.Equals(operation.OperationId,"GetStreamTransferSegment",OrdinalIgnoreCase))
        {
                ...
                Content = new Dictionary<String,OpenApiMediaType>
                {
                    [TransferEnvelope.MediaType] = new OpenApiMediaType
                    {
                        Schema = new OpenApiSchema
                        {
                            ...
                            Format = "binary",
                            Description = "Stream transfer envelope stream containing the requested payload segment and trailing footer metadata."
                        }
                    }
                }
            };
