...
internal sealed class ReOpenUploadTransferTransformer : IOpenApiOperationTransformer
{
    ...
    {
        if(String.Equals(operation.OperationId,"ReOpenUploadTransfer",OrdinalIgnoreCase))
        {
