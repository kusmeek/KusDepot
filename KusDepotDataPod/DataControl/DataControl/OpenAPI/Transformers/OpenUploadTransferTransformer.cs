...
internal sealed class OpenUploadTransferTransformer : IOpenApiOperationTransformer
{
    ...
    {
        if(String.Equals(operation.OperationId,"OpenUploadTransfer",OrdinalIgnoreCase))
        {
