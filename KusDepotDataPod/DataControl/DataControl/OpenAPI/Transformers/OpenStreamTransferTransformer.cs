...
internal sealed class OpenStreamTransferTransformer : IOpenApiOperationTransformer
{
    ...
    {
        if(String.Equals(operation.OperationId,"OpenStreamTransfer",OrdinalIgnoreCase))
        {
