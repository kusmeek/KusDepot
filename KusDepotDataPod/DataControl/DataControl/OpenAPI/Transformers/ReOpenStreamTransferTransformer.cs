...
internal sealed class ReOpenStreamTransferTransformer : IOpenApiOperationTransformer
{
    ...
    {
        if(String.Equals(operation.OperationId,"ReOpenStreamTransfer",OrdinalIgnoreCase))
        {
