...
internal sealed class ReOpenFollowStreamTransferTransformer : IOpenApiOperationTransformer
{
    ...
    {
        if(String.Equals(operation.OperationId,"ReOpenFollowStreamTransfer",OrdinalIgnoreCase))
        {
