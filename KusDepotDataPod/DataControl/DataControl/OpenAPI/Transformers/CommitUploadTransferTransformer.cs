...
internal sealed class CommitUploadTransferTransformer : IOpenApiOperationTransformer
{
    ...
    {
        if(String.Equals(operation.OperationId,"CommitUploadTransfer",OrdinalIgnoreCase))
        {
