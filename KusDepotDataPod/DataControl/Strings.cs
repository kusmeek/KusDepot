...
{
    public const String ConfigFilePath        = @"C:\KusDepotConfig\DataPod\DataControl\appsettings.json";
    public const String DiskStorePath         = @"C:\KusDepotDiskStore";
    public const String LogFilePath           = @"C:\KusDepotLogs\DataPod\DataControl.log";
