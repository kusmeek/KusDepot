...
{
    public static String ConfigFilePath            => CatalogDBConfigFilePath;
    public static String LogFilePath               => GetCatalogDBLogFilePath("CatalogDB");
    public static String LogDirectory              => CatalogDBLogDirectoryPath;
    ...
    public const String InitializeReadyDatabaseFail = @"CatalogDB InitializeReadyDatabase Failed {@Catalog}";
