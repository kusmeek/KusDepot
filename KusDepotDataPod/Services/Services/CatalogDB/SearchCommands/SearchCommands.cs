...
{
    public async Task<CommandResponse> SearchCommands(CommandQuery? search , String? traceid = null , String? spanid = null , CancellationToken cancel = default)
    {
        ...
        try
        {
            ...
            if(results.Count == 0) { SetOk(da); return new CommandResponse(); }
        ...
        {
            Logger.Error(_,SCFail); SetErr(da);
