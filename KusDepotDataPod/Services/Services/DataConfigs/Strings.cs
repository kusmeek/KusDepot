...
{
    public static String AdminFilePath       => DataConfigurationAdminSiloFilePath;
    public static String ConfigFilePath      => DataConfigurationConfigFilePath;
    public static String LogFilePath         => DataConfigurationLogFilePath;
    public static String StartUpSiloFilePath => DataConfigurationStartUpSiloFilePath;
    ...
    public const String IsAdminFail         = @"DataConfiguration IsAdmin Failed";
