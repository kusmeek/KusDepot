...
{
    public const String ConfigFilePath      = @"C:\KusDepotConfig\DataPod\Catalog\appsettings.json";
    public const String LogFilePath         = @"C:\KusDepotLogs\DataPod\Catalog.log";
    ...
    public const String TraceSourceName     = @"DataPodServices.Catalog";
