...
internal partial class Blob
{
    ...
    {
        Trace = new ActivitySource("KusDepot.Data.Blob","0.0.1");

        Tracer = Sdk.CreateTracerProviderBuilder().ConfigureResource(_=>{_.Clear();}).AddSource("KusDepot.Data.Blob").AddOtlpExporter().AddConsoleExporter().Build();
    }
