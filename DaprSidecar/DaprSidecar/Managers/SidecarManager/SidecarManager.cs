...
public sealed class SidecarManager : Tool , IManager
{
    ...
    public SidecarManager(IAccessManager? accessmanager = null , IEnumerable<DataItem>? data = null , Guid? id = null , IEnumerable<Meta<ICommand>>? commands = null,
    ...
    public override async Task StartingAsync(CancellationToken? cancel = null , AccessKey? key = null)
    {
        ...
        try
        {
            ...
            if((LifeState.StartingOK() is false) || (this.Locked && this.AccessCheck(key) is false)) { return; }
    ...
    public override async Task StartAsync(CancellationToken? cancel = null , AccessKey? key = null)
    {
        ...
        try
        {
            ...
            if((LifeState.StartOK() is false) || (this.Locked && this.AccessCheck(key) is false)) { return; }
    ...
    public override async Task StopAsync(CancellationToken? cancel = null , AccessKey? key = null)
    {
        ...
        try
        {
            ...
            if((LifeState.StopOK() is false) || (this.Locked && this.AccessCheck(key) is false)) { return; }
