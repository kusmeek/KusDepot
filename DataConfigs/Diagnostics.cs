...
internal partial class DataConfigs
{
    ...
    {
        Trace = new ActivitySource("KusDepot.Data.DataConfigs","0.0.1");

        Tracer = Sdk.CreateTracerProviderBuilder().ConfigureResource(_=>{_.Clear();}).AddSource("KusDepot.Data.DataConfigs").AddOtlpExporter().AddConsoleExporter().Build();
    }
