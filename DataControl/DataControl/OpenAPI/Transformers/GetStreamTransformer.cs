...
internal sealed class GetStreamTransformer : IOpenApiOperationTransformer
{
    ...
    {
        if(String.Equals(operation.OperationId,"GetStream",OrdinalIgnoreCase))
        {
            operation.Responses?.TryAdd("200", new OpenApiResponse
            {
                ...
                Content = new Dictionary<String,OpenApiMediaType>
                {
                    ["application/octet-stream"] = new OpenApiMediaType
                    {
                        ...
                        {
                            Type = "string",Description = "Content Stream",Format = "binary"
                        }
                    }
                },
                ...
                {
                    ["DataControlDownload"] = new OpenApiHeader
                    {
                        Description = "Serialized DataControlDownload",
