...
public class ToolAspireHostBuilder : ToolBuilder , IToolAspireHostBuilder
{
    ...
    public IToolAspireHost BuildAspireHost(DistributedApplication? app = null)
    {
        try
        {
            ...
            var _ = new ToolAspireHost(accessmanager:AccessManager,services:BuildServiceProvider(),commands:Commands,configuration:Context!.Configuration,aspireapplication:a,lifeid:i,lifetime:l);
    ...
    public IToolAspireHost BuildAspireHost<TToolAspireHost>(DistributedApplication? app = null) where TToolAspireHost : notnull , IToolAspireHost , new()
    {
        try
        {
            ...
            _ = (IToolAspireHost?)Activator.CreateInstance(typeof(TToolAspireHost),AccessManager,null,null,BuildServiceProvider(),Commands,Context!.Configuration,i,l,null,a);
