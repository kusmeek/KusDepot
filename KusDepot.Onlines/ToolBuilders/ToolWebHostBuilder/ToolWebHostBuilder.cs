...
public class ToolWebHostBuilder : ToolBuilder , IToolWebHostBuilder
{
    ...
    public IToolWebHost BuildWebHost(WebApplication? app = null)
    {
        try
        {
            ...
            var _ = new ToolWebHost(accessmanager:AccessManager,services:BuildServiceProvider(),commands:Commands,configuration:Context!.Configuration,urls:a.Urls,webapplication:a,lifeid:i,lifetime:l,logger:new LoggerConfiguration().WriteTo.ILogger(a.Logger).CreateLogger());
    ...
    public IToolWebHost BuildWebHost<TToolWebHost>(WebApplication? app = null) where TToolWebHost : notnull , IToolWebHost , new()
    {
        try
        {
            ...
            _ = (IToolWebHost?)Activator.CreateInstance(typeof(TToolWebHost),AccessManager,null,null,BuildServiceProvider(),Commands,Context!.Configuration,i,l,null,a.Urls,a);
