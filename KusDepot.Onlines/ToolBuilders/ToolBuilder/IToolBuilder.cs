...
public interface IToolBuilder
{
    ...
    IToolBuilder UseLogger(Serilog.ILogger logger);
    ...
    /**<include file='IToolBuilder.xml' path='IToolBuilder/interface[@name="IToolBuilder"]/method[@name="ConfigureContainer"]/*'/>*/
    IToolBuilder ConfigureContainer(Action<ToolBuilderContext,Autofac.ContainerBuilder> action);
    ...
    IToolBuilder RegisterTool(ITool tool) { return tool is not null ? this.ConfigureContainer((x,b) => b.RegisterInstance<IHostedService>(tool)) : this; }

    /**<include file='IToolBuilder.xml' path='IToolBuilder/interface[@name="IToolBuilder"]/method[@name="RegisterToolType"]/*'/>*/
    IToolBuilder RegisterTool<TTool>() where TTool : notnull , ITool , new() { return this.ConfigureContainer((x,b) => { b.RegisterType<TTool>().AsSelf().AsImplementedInterfaces();});}
}