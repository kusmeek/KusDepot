...
public class ToolGenericHostBuilder : ToolBuilder , IToolGenericHostBuilder
{
    ...
    public IToolGenericHost BuildGenericHost(IHost? host = null)
    {
        try
        {
            ...
            var _ = new ToolGenericHost(accessmanager:AccessManager,services:BuildServiceProvider(),commands:Commands,configuration:Context!.Configuration,host:host ?? h,lifeid:i,lifetime:l);
    ...
    public IToolGenericHost BuildGenericHost<TToolGenericHost>(IHost? host = null) where TToolGenericHost : notnull , IToolGenericHost , new()
    {
        try
        {
            ...
            try { _ = (IToolGenericHost?)Activator.CreateInstance(typeof(TToolGenericHost),AccessManager,null,null,BuildServiceProvider(),Commands,Context!.Configuration,host ?? h,i,l,null); }

            catch { _ = new ToolGenericHost(accessmanager:AccessManager,commands:Commands,services:BuildServiceProvider(),configuration:Context!.Configuration,host:host ?? h,lifeid:i,lifetime:l); }
