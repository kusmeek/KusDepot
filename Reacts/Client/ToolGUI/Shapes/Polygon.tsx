...
export default class Polygon extends React.Component<ShapeBase,ShapeState>
{
    ...
    render()
    {
        try
        {
            const { id, rgb, x, y, rotation, scale, sides, ghost, ghostOpacity, selected, onMouseDown, onTouchStart, onTouchEnd } = this.props;
            ...
            const containerStyle: React.CSSProperties = {
                ...
                clipPath: this.getPolygonClipPathPoints(sides ?? 12),
