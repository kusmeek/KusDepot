...
public partial class ReactorCore : Hub
{
    ...
    public async Task AddShape(ToolShape shape)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,AddShapeFail); }
    }
    ...
    public override async Task OnDisconnectedAsync(Exception? exception)
    {
        try
        {
            await Clients.Others.SendAsync(CursorRemoved,Context.ConnectionId);
        }
        catch ( Exception _ ) { Log.Error(_,OnDisconnectedFail); }
    ...
    public async Task PurgeCore()
    {
        ...
        catch ( Exception _ ) { Log.Error(_,PurgeCoreFail); }
    }
    ...
    public async Task RandomizeShape(ToolShape shape)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,RandomizeShapeFail); }
    }
    ...
    public async Task RandomizeShapeFH(ToolShape shape)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,RandomizeShapeFHFail); }
    }
    ...
    public async Task RandomizeShapeFG(ToolShape shape)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,RandomizeShapeFGFail); }
    }
    ...
    public async Task RandomizeShapeGH(ToolShape shape)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,RandomizeShapeGHFail); }
    }
    ...
    public async Task RandomizeShapeGG(ToolShape shape)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,RandomizeShapeGGFail); }
    }
    ...
    public async Task RandomizeShapeJH(ToolShape shape)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,RandomizeShapeJHFail); }
    }
    ...
    public async Task RandomizeShapeJG(ToolShape shape)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,RandomizeShapeJGFail); }
    }
    ...
    public async Task RandomizeShapeNH(ToolShape shape)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,RandomizeShapeNHFail); }
    }
    ...
    public async Task RandomizeShapeNG(ToolShape shape)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,RandomizeShapeNGFail); }
    }
    ...
    public async Task RandomizeShapePH(ToolShape shape)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,RandomizeShapePHFail); }
    }
    ...
    public async Task RandomizeShapePG(ToolShape shape)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,RandomizeShapePGFail); }
    }
    ...
    public async Task RandomizeShapeRH(ToolShape shape)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,RandomizeShapeRHFail); }
    }
    ...
    public async Task RandomizeShapeRG(ToolShape shape)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,RandomizeShapeRGFail); }
    }
    ...
    public async Task ReMakeShape(ToolShape shape)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,ReMakeShapeFail); }
    }
    ...
    public async Task RemoveShape(Guid id)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,RemoveShapeFail); }
    }
    ...
    public async Task SendMessage(ToolMessage message)
    {
        try
        {
            ...
            CommandRegistry.Commands?.TryGetValue("SendMessage",out var tools);

            message = message with { id = Guid.NewGuid() }; await Clients.All.SendAsync(MessageReceived,message);
        }
        catch ( Exception _ ) { Log.Error(_,SendMessageFail); }
    }
    ...
    public async Task SetCoreSpeed(Int32 speed)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,SetCoreSpeedFail); }
    }

    public async Task UpdateCursorPosition(CursorPosition cursor)
    {
        try
        {
            if(cursor is null || cursor.x is null || cursor.y is null) { return; }

            var _ = cursor with { connectionId = Context.ConnectionId , name = Sanitize(cursor.name) , rgb = cursor.rgb };

            await Clients.Others.SendAsync(CursorPositionUpdated,_);
        }
        catch ( Exception _ ) { Log.Error(_,UpdateCursorPositionFail); }
    }
    ...
    public async Task UpdateShape(ToolShape shape)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,UpdateShapeFail); }
    }
    ...
    public async Task UpdateShapePosition(ToolShapePosition position)
    {
        ...
        catch ( Exception _ ) { Log.Error(_,UpdateShapePositionFail); }
    }

    public async Task UpdateShapePositions(ToolShapePosition[] positions)
    {
        try
        {
            if(positions is null || positions.Length is 0) { return; }

            foreach(var position in positions)
            {
                if(position is null || Equals(Guid.Empty,position.id)) { continue; }

                await Clients.All.SendAsync(ShapePositionUpdated,position);
            }
        }
        catch ( Exception _ ) { Log.Error(_,UpdateShapePositionsFail); }
    }
