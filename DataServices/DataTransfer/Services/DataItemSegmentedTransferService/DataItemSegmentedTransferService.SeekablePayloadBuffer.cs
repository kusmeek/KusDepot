...
{
    /**<include file='DataItemSegmentedTransferService.xml' path='DataItemSegmentedTransferService/class[@name="SeekablePayloadBuffer"]/main/*'/>*/
    private sealed class SeekablePayloadBuffer : IAsyncDisposable
    {
        /**<include file='DataItemSegmentedTransferService.xml' path='DataItemSegmentedTransferService/class[@name="SeekablePayloadBuffer"]/property[@name="Stream"]/*'/>*/
        public Stream Stream { get; }

        /**<include file='DataItemSegmentedTransferService.xml' path='DataItemSegmentedTransferService/class[@name="SeekablePayloadBuffer"]/constructor[@name="SeekablePayloadBuffer"]/*'/>*/
        private SeekablePayloadBuffer(Stream stream) => this.Stream = stream;

        /**<include file='DataItemSegmentedTransferService.xml' path='DataItemSegmentedTransferService/class[@name="SeekablePayloadBuffer"]/method[@name="Create"]/*'/>*/
        public static async Task<SeekablePayloadBuffer> Create(Stream source , Int64 expectedlength , String? temporaryuploadpath , CancellationToken cancel)
        {
            ...
            String path = Path.Combine(rootPath,$"KusDepot.SegmentedTransfer.{Guid.NewGuid():N}.tmp");
        ...
        /**<include file='DataItemSegmentedTransferService.xml' path='DataItemSegmentedTransferService/class[@name="SeekablePayloadBuffer"]/method[@name="DisposeAsync"]/*'/>*/
