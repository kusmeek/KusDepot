...
internal class Laboperator
{
    private static async Task Main(String[] args)
    {
        ...
        ab.Builder.Services.AddSerilog(Log.Logger); ab.UseBuilderOptions(o).UseLogger(new SerilogLoggerFactory()).AutoStart();
        ...
        var aspirehost = await ab.BuildAspireHostAsync();
