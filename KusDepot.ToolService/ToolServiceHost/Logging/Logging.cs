...
internal sealed partial class ToolServiceHost
{
    public static void SetupLogging(WebApplicationBuilder builder)
    {
        ...
        IConfigurationRoot c = new ConfigurationBuilder().AddJsonFile(ToolService.ConfigFilePath,true,true).Build();
    ...
    private static String LogFilePath => @"C:\KusDepotLogs\ToolService\ToolService-" + ProcessId + @".log"; 
}