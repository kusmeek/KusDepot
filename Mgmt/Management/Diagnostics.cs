...
internal partial class Management
{
    ...
    {
        Trace = new ActivitySource("KusDepot.Data.Management","0.0.1");

        Tracer = Sdk.CreateTracerProviderBuilder().ConfigureResource(_=>{_.Clear();}).AddSource("KusDepot.Data.Management").AddOtlpExporter().AddConsoleExporter().Build();
    }
