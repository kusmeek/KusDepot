...
internal static class ManagementStartUp
{
    private static void Main()
    {
        try
        {
            ...
            ActorRuntime.RegisterActorAsync<Management>( (context,type) => { return new ActorService(context,type); }).GetAwaiter().GetResult();
