...
public interface IToolAspireHostBuilder : IToolBuilder
{
    ...
    /**<include file='IToolAspireHostBuilder.xml' path='IToolAspireHostBuilder/interface[@name="IToolAspireHostBuilder"]/method[@name="BuildAspireHostOpenFactory"]/*'/>*/
    IToolAspireHost BuildAspireHost<TToolAspireHost>(ToolAspireHostFactory<TToolAspireHost> factory , DistributedApplication? app = null) where TToolAspireHost : notnull , IToolAspireHost , new();
    ...
    /**<include file='IToolAspireHostBuilder.xml' path='IToolAspireHostBuilder/interface[@name="IToolAspireHostBuilder"]/method[@name="BuildAspireHostAsyncOpenFactory"]/*'/>*/
    Task<IToolAspireHost> BuildAspireHostAsync<TToolAspireHost>(ToolAspireHostFactory<TToolAspireHost> factory , DistributedApplication? app = null , CancellationToken cancel = default) where TToolAspireHost : notnull , IToolAspireHost , new();
