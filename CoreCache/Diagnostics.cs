...
internal partial class CoreCache
{
    ...
    {
        Trace = new ActivitySource("KusDepot.Data.CoreCache","0.0.1");

        Tracer = Sdk.CreateTracerProviderBuilder().ConfigureResource(_=>{_.Clear();}).AddSource("KusDepot.Data.CoreCache").AddOtlpExporter().AddConsoleExporter().Build();
    }
